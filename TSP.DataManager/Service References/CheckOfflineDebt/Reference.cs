...
namespace TSP.DataManager.CheckOfflineDebt {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="CheckOfflineDebt.CheckOfflineDebtSoap")]
    public interface CheckOfflineDebtSoap {
        ...
        TSP.DataManager.CheckOfflineDebt.GetSumDebtResponse GetSumDebt(TSP.DataManager.CheckOfflineDebt.GetSumDebtRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        TSP.DataManager.CheckOfflineDebt.AddPaymentResponse AddPayment(TSP.DataManager.CheckOfflineDebt.AddPaymentRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        TSP.DataManager.CheckOfflineDebt.UpdatePaymentResponse UpdatePayment(TSP.DataManager.CheckOfflineDebt.UpdatePaymentRequest request);
    }
    ...
    public partial class GetSumDebtRequest {
        ...
        public TSP.DataManager.CheckOfflineDebt.AuthSoapHd AuthSoapHd;
        ...
        public GetSumDebtRequest(TSP.DataManager.CheckOfflineDebt.AuthSoapHd AuthSoapHd, string memCode) {
    ...
    public partial class AddPaymentRequest {
        ...
        public AddPaymentRequest(TSP.DataManager.CheckOfflineDebt.AuthSoapHd AuthSoapHd, string memCode, string firstName, string lastName, string amount, string paymentId, System.DateTime PaymentDate, string refId) {
            this.AuthSoapHd = AuthSoapHd;
            this.memCode = memCode;
    ...
    public partial class UpdatePaymentRequest {
        ...
        public UpdatePaymentRequest(TSP.DataManager.CheckOfflineDebt.AuthSoapHd AuthSoapHd, string id) {
            this.AuthSoapHd = AuthSoapHd;
            this.id = id;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface CheckOfflineDebtSoapChannel : TSP.DataManager.CheckOfflineDebt.CheckOfflineDebtSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CheckOfflineDebtSoapClient : System.ServiceModel.ClientBase<TSP.DataManager.CheckOfflineDebt.CheckOfflineDebtSoap>, TSP.DataManager.CheckOfflineDebt.CheckOfflineDebtSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TSP.DataManager.CheckOfflineDebt.GetSumDebtResponse TSP.DataManager.CheckOfflineDebt.CheckOfflineDebtSoap.GetSumDebt(TSP.DataManager.CheckOfflineDebt.GetSumDebtRequest request) {
            return base.Channel.GetSumDebt(request);
        }
        
        public string GetSumDebt(TSP.DataManager.CheckOfflineDebt.AuthSoapHd AuthSoapHd, string memCode) {
            TSP.DataManager.CheckOfflineDebt.GetSumDebtRequest inValue = new TSP.DataManager.CheckOfflineDebt.GetSumDebtRequest();
            inValue.AuthSoapHd = AuthSoapHd;
            inValue.memCode = memCode;
            TSP.DataManager.CheckOfflineDebt.GetSumDebtResponse retVal = ((TSP.DataManager.CheckOfflineDebt.CheckOfflineDebtSoap)(this)).GetSumDebt(inValue);
            return retVal.GetSumDebtResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TSP.DataManager.CheckOfflineDebt.AddPaymentResponse TSP.DataManager.CheckOfflineDebt.CheckOfflineDebtSoap.AddPayment(TSP.DataManager.CheckOfflineDebt.AddPaymentRequest request) {
            return base.Channel.AddPayment(request);
        }
        
        public string AddPayment(TSP.DataManager.CheckOfflineDebt.AuthSoapHd AuthSoapHd, string memCode, string firstName, string lastName, string amount, string paymentId, System.DateTime PaymentDate, string refId) {
            TSP.DataManager.CheckOfflineDebt.AddPaymentRequest inValue = new TSP.DataManager.CheckOfflineDebt.AddPaymentRequest();
            inValue.AuthSoapHd = AuthSoapHd;
            inValue.memCode = memCode;
            ...
            inValue.refId = refId;
            TSP.DataManager.CheckOfflineDebt.AddPaymentResponse retVal = ((TSP.DataManager.CheckOfflineDebt.CheckOfflineDebtSoap)(this)).AddPayment(inValue);
            return retVal.AddPaymentResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TSP.DataManager.CheckOfflineDebt.UpdatePaymentResponse TSP.DataManager.CheckOfflineDebt.CheckOfflineDebtSoap.UpdatePayment(TSP.DataManager.CheckOfflineDebt.UpdatePaymentRequest request) {
            return base.Channel.UpdatePayment(request);
        }
        
        public string UpdatePayment(TSP.DataManager.CheckOfflineDebt.AuthSoapHd AuthSoapHd, string id) {
            TSP.DataManager.CheckOfflineDebt.UpdatePaymentRequest inValue = new TSP.DataManager.CheckOfflineDebt.UpdatePaymentRequest();
            inValue.AuthSoapHd = AuthSoapHd;
            inValue.id = id;
            TSP.DataManager.CheckOfflineDebt.UpdatePaymentResponse retVal = ((TSP.DataManager.CheckOfflineDebt.CheckOfflineDebtSoap)(this)).UpdatePayment(inValue);
