...
{
    public class AccountingTTManager:BaseObject
    {

        public  AccountingTTManager()
            : base()
        {
        }

        public AccountingTTManager(System.Data.DataSet ds)
            : base(ds)
        {
        }
        ...
        {
            return BaseObject.GetUserPermission(UserId, ut, TableType.AccountingTT);
        }
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "Accounting.TT";
            ...
            this.Adapter.SelectCommand.CommandText = "dbo.spSelectTT";
            this.Adapter.SelectCommand.CommandType = System.Data.CommandType.StoredProcedure;

            this.Adapter.DeleteCommand = new System.Data.SqlClient.SqlCommand();
            this.Adapter.DeleteCommand.Connection = this.Connection;
            this.Adapter.DeleteCommand.CommandText = "dbo.spDeleteTT";
            ...
            this.Adapter.InsertCommand.CommandText = "dbo.spInsertTT";
            ...
            this.Adapter.UpdateCommand.CommandText = "dbo.spUpdateTT";
        ...
        public override System.Data.DataTable DataTable
        {
            get
            {
                if ((this._dataTable == null))
                {
                    ...
                    this._dataTable = new DataManager.AccountingDataSet.AccountingTTDataTable();
