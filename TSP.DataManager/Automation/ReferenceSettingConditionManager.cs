...
{
    public class ReferenceSettingConditionManager : BaseObject
    {
        protected override void InitAdapter()
        {
            System.Data.Common.DataTableMapping tableMapping = new System.Data.Common.DataTableMapping();
            tableMapping.SourceTable = "Table";
            tableMapping.DataSetTable = "ReferenceSettingCondition";
            tableMapping.ColumnMappings.Add("RefSetCondId", "RefSetCondId");
            ...
            this.Adapter.SelectCommand.CommandText = "dbo.spSelectAutomationReferenceSettingCondition";
            this.Adapter.SelectCommand.CommandType = System.Data.CommandType.StoredProcedure;
            this.Adapter.SelectCommand.Parameters.Add("@RefSetCondId", System.Data.SqlDbType.Int);
            ...
            this.Adapter.DeleteCommand.CommandText = "dbo.spDeleteAutomationReferenceSettingCondition";
            this.Adapter.DeleteCommand.CommandType = System.Data.CommandType.StoredProcedure;
            this.Adapter.DeleteCommand.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Variant, 0, System.Data.ParameterDirection.ReturnValue, 0, 0, null, System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this.Adapter.DeleteCommand.Parameters.Add(new System.Data.SqlClient.SqlParameter("@Original_RefSetCondId", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "RefSetCondId", System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this.Adapter.DeleteCommand.Parameters.Add(new System.Data.SqlClient.SqlParameter("@Original_LastTimeStamp", System.Data.SqlDbType.Timestamp, 0, System.Data.ParameterDirection.Input, 0, 0, "LastTimeStamp", System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this.Adapter.InsertCommand = new System.Data.SqlClient.SqlCommand();
            this.Adapter.InsertCommand.Connection = this.Connection;
            this.Adapter.InsertCommand.CommandText = "dbo.spInsertAutomationReferenceSettingCondition";
            ...
            this.Adapter.UpdateCommand.CommandText = "dbo.spUpdateAutomationReferenceSettingCondition";
            ...
            this.Adapter.UpdateCommand.Parameters.Add(new System.Data.SqlClient.SqlParameter("@Original_RefSetCondId", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "RefSetCondId", System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this.Adapter.UpdateCommand.Parameters.Add(new System.Data.SqlClient.SqlParameter("@Original_LastTimeStamp", System.Data.SqlDbType.Timestamp, 0, System.Data.ParameterDirection.Input, 0, 0, "LastTimeStamp", System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this.Adapter.UpdateCommand.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RefSetCondId", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, 0, 0, "RefSetCondId", System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public override System.Data.DataTable DataTable
        {
            get
            {
                ...
                {
                    this._dataTable = new DataManager.Automation.AutomationDataSet.ReferenceSettingConditionDataTable();
        ...
        public DataTable FindByCode(int RefSetCondId)
        {
            this.ResetAllParameters();
            this.Adapter.SelectCommand.Parameters["@RefSetCondId"].Value = RefSetCondId;
            this.Fill();
        ...
        public DataTable FindByTableType(int RefSetId, int tableType)
        {
            this.ResetAllParameters();
            this.Adapter.SelectCommand.Parameters["@RefSetId"].Value = RefSetId;
