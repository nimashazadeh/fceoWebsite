...
namespace TSP.DataManager.Automation.FormCreator
{
    public class ElementItemsManager : BaseObject
    {
        ...
        protected override void InitAdapter()
        {
            ...
            this.Adapter.SelectCommand.CommandText = "dbo.spSelectFormCreatorElementItems";
            ...
            this.Adapter.DeleteCommand.CommandText = "dbo.spDeleteFormCreatorElementItems";
            ...
            this.Adapter.InsertCommand.CommandText = "dbo.spInsertFormCreatorElementItems";
            ...
            this.Adapter.UpdateCommand.CommandText = "dbo.spUpdateFormCreatorElementItems";
        ...
        public override System.Data.DataTable DataTable
        {
            get
            {
                if ((this._dataTable == null))
                {
                    ...
                    this._dataTable = new DataManager.Automation.FormCreator.FormCreatorDataSet.ElementItemsDataTable();
        ...
        public void FindByElementId(int ElementId)
        {
            ResetAllParameters();
        ...
        public void FindByLetterCreationTypeId(int LetterCreationTypeId)
        {
            ResetAllParameters();
            this.Adapter.SelectCommand.Parameters["@LetterCreationTypeId"].Value = LetterCreationTypeId;
            Fill();
        }
    }
}
