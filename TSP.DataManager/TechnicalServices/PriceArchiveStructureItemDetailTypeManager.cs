...
{
    public class PriceArchiveStructureItemDetailTypeManager : TSP.DataManager.BaseObject
    {
        public enum Types
        {
            Design = 1, Supervision = 2
        }

        public static Permission GetUserPermission(int UserId, UserType ut)
        {
            return BaseObject.GetUserPermission(UserId, ut, TableType.TS_PriceArchiveStructureItemDetailType);
        }
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "TS.PriceArchiveStructureItemDetailType";
            ...
            this.Adapter.SelectCommand.CommandText = "dbo.spSelectTSPriceArchiveStructureItemDetailType";
            this.Adapter.SelectCommand.CommandType = global::System.Data.CommandType.StoredProcedure;

            this.Adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this.Adapter.DeleteCommand.Connection = this.Connection;
            this.Adapter.DeleteCommand.CommandText = "dbo.spDeleteTSPriceArchiveStructureItemDetailType";
            ...
            this.Adapter.InsertCommand.CommandText = "dbo.spInsertTSPriceArchiveStructureItemDetailType";
            ...
            this.Adapter.UpdateCommand.CommandText = "dbo.spUpdateTSPriceArchiveStructureItemDetailType";
        ...
        public override System.Data.DataTable DataTable
        {
            get
            {
                if ((this._dataTable == null))
                {
                    ...
                    this._dataTable = new DataManager.TechnicalServices.TechnicalServicesDataSet._TS_PriceArchiveStructureItemDetailTypeDataTable();
