<%@ Page Title="سوالات نظرسنجی" Language="C#" MasterPageFile="~/MasterPageWebsite.master"
    AutoEventWireup="true" CodeFile="AnswerPollQuestion.aspx.cs" Inherits="Poll_AnswerPollQuestion" %>
                        ...
                        <dxp:ASPxPanel ID="PanelQuestions" runat="server" Width="100%">
                            <PanelCollection>
                                <dxp:PanelContent>
                                    <table width="100%">
                                        <tr>
                                            <td align="right" valign="top" class="HelpUL">
                                                <dxe:ASPxLabel ID="lblPollDescription" runat="server" Width="100%" Text="" Wrap="True">
                                                </dxe:ASPxLabel>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="top">
                                                <dxe:ASPxHyperLink ID="HyperLinkAttachment" runat="server" Target="_blank" Text="دریافت فایل پیوست">
                                                </dxe:ASPxHyperLink>
                                            </td>
                                        </tr>
                                        <tr>
