...
public partial class Settlement_OfficeDocument_OfficeAgent : System.Web.UI.Page
{
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("OfficeAgentShow.aspx?OagId=" + Utility.EncryptQS(OagId.ToString()) + "&OfId=" + OfficeId.Value + "&OfReId=" + OfficeRequest.Value + "&PageMode=" + PgMode.Value + "&GrdFlt=" + Request.QueryString["GrdFlt"]);
        }
