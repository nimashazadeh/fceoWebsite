<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ObserverPermitted.aspx.cs"
    Inherits="ReportForms_TechnicalServices_ObserverPermitted" %>
...
<head id="Head1" runat="server">
    <title>چاپ نامه شهرداری-تایید ناظر</title>
</head>
<body>
