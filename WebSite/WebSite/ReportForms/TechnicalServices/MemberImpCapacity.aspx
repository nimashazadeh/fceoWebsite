<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberImpCapacity.aspx.cs" Inherits="ReportForms_TechnicalServices_MemberImpCapacity" %>
...
<head id="Head1" runat="server">
    <title>گزارش ظرفیت اجرای عضو حقیقی</title>
</head>
<body>
