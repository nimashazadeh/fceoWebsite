<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberInQueryLicence.aspx.cs"
    Inherits="ReportForms_MemberInQueryLicence" %>
...
<head runat="server">
    <title>درخواست استعلام مدرک از واحد آموزشی</title>
</head>
<body>
       ...
       s.cpMsg = '';
            ...
            <PanelCollection>
                <dx:PanelContent ID="PanelContent5" runat="server">
                    <TSPControls:CustomPrintToolbar ID="CustomPrintToolbar1" runat="server" ReportViewer="<%# RptVMembersLicence %>">
 ...
 if(e.item.name == &quot;PrintReport&quot;)  {
   CallbackPanelReport.PerformCallback();
                    ...
                    <br />
                    <dxxr:ReportViewer ID="RptVMembersLicence" PrintUsingAdobePlugIn="false" runat="server"
