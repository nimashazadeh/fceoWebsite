<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnvelopeReport.aspx.cs" Inherits="ReportForms_EnvelopeReport" %>
...
<body>
    ...
    <div>
        <div id="DivContent" style="width: 100%" align="center">
            ...
            <br />
            <dxxr:reportviewer id="ReportViewer1" PrintUsingAdobePlugIn="False" 
                runat="server" LoadingPanelText="درحال بارگذاری"></dxxr:reportviewer>
            <br />
        </div>
    </div>
    </form>
