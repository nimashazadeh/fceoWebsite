...
public partial class ReportForms_Accounting_PeriodDocBalanceBalance3 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string DocDateFrom, DocDateTo, AgentId, FilterExp, DocStatusId, Level,PId;
        ...
        XtraReportPeriodBalance3 Balance3R = new XtraReportPeriodBalance3(Convert.ToInt32(PId), DocDateFrom, DocDateTo, Convert.ToInt32(AgentId), FilterExp, Convert.ToInt32(DocStatusId), Convert.ToInt32(Level));
