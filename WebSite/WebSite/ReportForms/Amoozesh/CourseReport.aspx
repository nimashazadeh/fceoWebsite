<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseReport.aspx.cs" Inherits="ReportForms_Amoozesh_CourseReport" %>
...
<head runat="server">
    <title>پیش نمایش گواهینامه دوره آموزشی</title>
</head>
<body>
    ...
    <div>
       ...
       <%--     <tspcontrols:customprinttoolbar id="CustomPrintToolbar1"  runat="server" ReportViewer="<%# ReportViewer1 %>" >
                <Items >
                    <dxxr:ReportToolbarItem/>
                </Items>
               
            </tspcontrols:customprinttoolbar>
            
            <br />--%>
            <dxxr:reportviewer id="ReportViewer1" PrintUsingAdobePlugIn="false" runat="server"></dxxr:reportviewer>
        <%--    <br />--%>
        </div>
    </div>
    </form>
