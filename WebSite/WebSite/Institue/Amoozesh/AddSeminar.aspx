<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="AddSeminar.aspx.cs" Inherits="Institue_Amoozesh_AddSeminar"
    Title="مشخصات سمینار" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript">
        ...
        function Enable() {
            ...
            //TextTeDesc.SetEnabled(true);
            //TextSal.SetEnabled(true);
        }
        function Disable() {
     ...
     if(gridTe.GetVisibleRowsOnPage()==0)
    {
     ...
     e.processOnServer=true;
            ...
            <TSPControls:CustomAspxMenuHorizontal runat="server" Visible="false" ID="AspxMenu1" OnItemClick="AspxMenu1_ItemClick">
                <Items>
                ...
                <PanelCollection>
                    <dxp:PanelContent>
                        <fieldset>
                            ...
                            <dxe:ASPxPanel ID="RoundPanelBaseInfo"
                                runat="server">
                                <PanelCollection>
                                    <dxe:PanelContent>
                                        ...
                                        <table dir="rtl" width="100%" align="right">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top" align="right" style="width: 35%">
                                                        ...
                                                        <%--  <pdc:PersianDateValidator runat="server" ClientValidationFunction="PersianDateValidator"
                                                            ValidateEmptyText="True" ControlToValidate="txtDate" ErrorMessage="تاریخ را وارد نمایید"
                                                            Display="Dynamic" ID="PersianDateValidator1"></pdc:PersianDateValidator>--%>
                                                    </td>
                                                    <td valign="top" align="right" style="width: 15%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top" align="right">
                                                        <TSPControls:CustomTextBox runat="server" Width="100%" MaxLength="5"
                                                            ID="txtTime">
                                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom">
                                                                <ErrorImage Height="14px" Url="~/App_Themes/Glass/Editors/edtError.png">
                                                                </ErrorImage>
                        ...
                        <fieldset>
                            <legend class="HelpUL">زمان بندی برنامه های سمینار</legend>
                            ...
                            <table runat="server" id="tblSchedule" dir="rtl" width="100%">
                                ...
                                <tr runat="server" id="Tr5">
                                    <td runat="server" id="TD13" valign="top" align="center" colspan="4">
                                        <br />
                                        <TSPControls:CustomAspxButton runat="server" UseSubmitBehavior="False" Text="اضافه به لیست" ValidationGroup="Sch"
                                            ID="btnAddSchedule"
                            ...
                            <table runat="server" id="tblTe" dir="rtl" width="100%">
                                <tr runat="server" id="Tr7">
                                    ...
                                    <td runat="server" id="Td16" dir="ltr" valign="top" align="right" colspan="3">
                                        <TSPControls:CustomAspxButton runat="server" AutoPostBack="False" UseSubmitBehavior="False" ClientInstanceName="btn"
	...
	pop.Show();
                                        ...
                                        <TSPControls:CustomTextBox runat="server" Width="100%" ClientInstanceName="TextID" ClientVisible="False"
                                            ID="txtTeID">
                                        </TSPControls:CustomTextBox>
                                        <TSPControls:CustomTextBox runat="server" Width="100%" ClientInstanceName="TextType" ClientVisible="False"
                                            ID="txtType">
                                        </TSPControls:CustomTextBox>
                                    </td>
                                </tr>
                                ...
                                <tr runat="server" id="Tr10">
                                    ...
                                    <td runat="server" id="Td29" valign="top" align="right">
                                        <TSPControls:CustomTextBox runat="server" Width="100%" MaxLength="10" ReadOnly="True"
	...
	SetControlValuesGrade();
            ...
            <div dir="rtl">
                <TSPControls:CustomASPxPopupControl ID="ASPxPopupControl1" runat="server"
                    HeaderText="جستجو" ClientInstanceName="pop"
                    CloseAction="CloseButton" PopupElementID="btnSearch1" PopupHorizontalAlign="WindowCenter"
