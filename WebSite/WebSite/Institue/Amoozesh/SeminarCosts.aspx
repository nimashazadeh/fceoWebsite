<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true" CodeFile="SeminarCosts.aspx.cs" Inherits="Institue_Amoozesh_SeminarCosts" Title="هزینه های متفرقه" %>
                                ...
                                <table dir="rtl" id="TABLE1">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="right" valign="top">
                                                <TSPControls:CustomTextBox IsMenuButton="true" runat="server" Width="140px" ID="txtPrice" ClientInstanceName="price">
