<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="AddPeriod.aspx.cs" Inherits="Institue_Amoozesh_AddPeriod"
        ...
        <ContentTemplate>
            ...
            <TSPControls:CustomAspxMenuHorizontal ID="AspxMenu1" runat="server" OnItemClick="AspxMenu1_ItemClick">
                <Items>
                    ...
                    <dxm:MenuItem Name="Costs" Text="هزینه های متفرقه" Visible="false">
                    </dxm:MenuItem>
                </Items>
                ...
                <PanelCollection>
                    <dxp:PanelContent>
                        <fieldset>
                            ...
                            <dx:ASPxPanel ID="PanelBaseInfo" runat="server">
                                <PanelCollection>
                                    <dx:PanelContent>
                                        <table dir="rtl" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td valign="top" align="right" style="width: 20%">کد درس</td>
                                                    <td dir="ltr" valign="top" align="right" colspan="3" style="width: 85%">
                                                        <TSPControls:CustomTextBox runat="server" ID="txtCrsCode" AutoPostBack="true"
                                                            Width="100%" ClientInstanceName="txtCrsCode" OnTextChanged="txtCrsCode_TextChanged">
                                                            <ValidationSettings>
                                                ...
                                                <tr>
                                                    ...
                                                    <td dir="ltr" valign="top" align="right" colspan="3" style="width: 85%">
                                                        <TSPControls:CustomAspxComboBox runat="server" PopupVerticalAlign="NotSet" Width="100%"
                                                            IncrementalFilteringMode="StartsWith" TextField="CrsTitle"
                                                            ID="cmbCrsId" AutoPostBack="True" DataSourceID="ODBCourse"
                                                            EnableClientSideAPI="True" ValueType="System.String" ValueField="CrsId" ClientInstanceName="combobox"
                                                            EnableIncrementalFiltering="True"
                                                            OnSelectedIndexChanged="cmbCrsId_SelectedIndexChanged" RightToLeft="True">
                                                ...
                                                <tr>
                                                    <td valign="top" align="right">
                                                        <dxe:ASPxLabel runat="server" Text="نوع دوره" ID="ASPxLabel38" Width="100%">
                                                        </dxe:ASPxLabel>
                                                    </td>
                                                    <td dir="ltr" valign="top" align="right">
                                                        <TSPControls:CustomAspxComboBox runat="server" PopupVerticalAlign="NotSet" Width="100%"
                                                            ...
                                                            <Items>
                                                                <dxe:ListEditItem Value="1" Text="دوره آزمون" Selected="True"></dxe:ListEditItem>
                                                                <dxe:ListEditItem Value="0" Text="دوره کامل"></dxe:ListEditItem>
                                                            </Items>
                                                            <ButtonStyle Width="13px">
                                                            </ButtonStyle>
                                                        </TSPControls:CustomAspxComboBox>
                        ...
                        <fieldset>
                            ...
                            <dx:ASPxPanel ID="PanelBaseTeacher" runat="server">
                                <PanelCollection>
                                    <dx:PanelContent>
                                        <table dir="rtl" width="100%">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td dir="ltr" valign="top" align="right" colspan="3">
                                                        <TSPControls:CustomAspxComboBox runat="server" EnableIncrementalFiltering="True" IncrementalFilteringMode="StartsWith"
                                                            ...
                                                            AutoPostBack="True" ClientInstanceName="combobox"
                                                            EnableClientSideAPI="True" ID="cmbTeId" OnSelectedIndexChanged="cmbTeId_SelectedIndexChanged"
                                                            RightToLeft="True">
                                                            <ItemStyle HorizontalAlign="Right" />
                                                            <%-- <Columns>
<dxe:ListBoxColumn FieldName="Father" Caption="نام پدر"></dxe:ListBoxColumn>
<dxe:ListBoxColumn FieldName="TeName" Caption="نام ارائه دهنده"></dxe:ListBoxColumn>
</Columns>--%>
                                                            <ButtonStyle Width="13px">
                                                            </ButtonStyle>
                                                ...
                                                <tr>
                                                    <td width="20%"></td>
                                                    <td width="30%">
                                                        <TSPControls:CustomAspxButton CssClass="ButtonMenue" runat="server" UseSubmitBehavior="False" ClientInstanceName="btn"
                                                            Text="اضافه به لیست" ValidationGroup="Te"
                                                            ID="btnAddTeacher" OnClick="btnAddTeacher_Click">
                                                        </TSPControls:CustomAspxButton>
                                                    </td>
                                                    <td  width="20%" >
                                                        <TSPControls:CustomAspxButton CssClass="ButtonMenue" runat="server" AutoPostBack="False" UseSubmitBehavior="False" CausesValidation="False"
                                                            Text="پاک کردن فرم"
	...
	btn.SetEnabled(true);
                            ...
                            <TSPControls:CustomAspxDevGridView2 runat="server" ClientInstanceName="grid"
                                ...
                                Width="100%" ID="GridViewTeacher" OnHtmlRowPrepared="GridViewTeacher_HtmlRowPrepared"
                                OnRowUpdating="GridViewTeacher_RowUpdating"
                                OnRowDeleting="GridViewTeacher_RowDeleting">
    ...
    if(s.cpError==1)
     {
       ...
       s.cpMsg = '';
                                ...
                                <Columns>
                                    ...
                                    <dxwgv:GridViewCommandColumn Caption=" " VisibleIndex="7" ShowDeleteButton="true" ShowEditButton="true">
                        ...
                        <fieldset>
                            ...
                            <TSPControls:CustomAspxDevGridView2 runat="server"
                                ...
                                OnRowUpdating="GridViewSchedule_RowUpdating"
    ...
    if(s.cpError==1)
     {
       ...
       s.cpMsg = '';
                                ...
                                <Columns>
                                    ...
                                    <dxwgv:GridViewDataTextColumn FieldName="Date" Caption="تاریخ" VisibleIndex="1">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <pdc:PersianDateTextBox ID="txtDate" runat="server" Width="100px" Text='<%# Bind("Date") %>'
                                                ...
                                                SetDefaultDateOnEvent="OnClick"></pdc:PersianDateTextBox>
                                    ...
                                    <dxwgv:GridViewCommandColumn Caption=" " VisibleIndex="5" ShowNewButton="true" ShowDeleteButton="true" ShowEditButton="true">
                                    </dxwgv:GridViewCommandColumn>
                                </Columns>
                            </TSPControls:CustomAspxDevGridView2>
                        </fieldset>
    ...
    <asp:ObjectDataSource ID="OdbSchedule" runat="server" FilterExpression="TtId={0}"
        SelectMethod="GetData" TypeName="TSP.DataManager.ScheduleManager" OnDeleting="OdbSchedule_Deleting"
        OnInserting="OdbSchedule_Inserting" OnUpdating="OdbSchedule_Updating">
        <FilterParameters>
