...
public partial class Institue_Amoozesh_AddSeminar : System.Web.UI.Page
{
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Seminar.aspx?InsId=" + Utility.EncryptQS(_SeId.ToString()));
    ...
    protected void AspxMenu1_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
    {
        ...
        {
            case "Costs":
                Response.Redirect("SeminarCosts.aspx?SeId=" + Utility.EncryptQS(_SeId.ToString()) + "&InsId=" + Utility.EncryptQS(_InsId.ToString()) + "&PageMode=" + Utility.EncryptQS(_PageMode));
                break;
        }
    }
    #endregion
