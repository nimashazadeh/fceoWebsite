...
public partial class Institue_Amoozesh_InActivePeriod : System.Web.UI.Page
{
    #region Events
    ...
    {
        Response.Redirect("AddPeriod.aspx?PPId=" + HiddenFieldPeriod["PPId"].ToString() + "&InsId=" + Request.QueryString["InsId"] + "&PageMode=" + Request.QueryString["PageMode"]);
    ...
    protected void AspxMenu1_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
    {
        ...
        {
            case "Costs":
                Response.Redirect("PeriodCosts.aspx?PPId=" + HiddenFieldPeriod["PPId"].ToString() + "&InsId=" + Request.QueryString["InsId"] + "&PageMode=" + Request.QueryString["PageMode"]);
            ...
            case "TestMarks":
                ...
                {
                    Response.Redirect("PeriodTestMarks.aspx?PPId=" + Utility.EncryptQS(PPId.ToString()) + "&InsId=" + Request.QueryString["InsId"] + "&PageMode=" + Request.QueryString["PageMode"]);
                }
                else
                {
    ...
    private void InsertTrainingStatusChange()
    {
        ...
        try
        {
            ...
            if (cn > 0)
            {
                ...
                if (PeriodPresentManager.Count == 1)
                {
                    PeriodPresentManager[0]["Status"] = (int)TSP.DataManager.PeriodPresentStatus.InvalidPeriod;
