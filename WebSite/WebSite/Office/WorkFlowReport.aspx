<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true" CodeFile="WorkFlowReport.aspx.cs" Inherits="Office_WorkFlowReport" Title="پیگیری جریان کار" %>
            ...
            <dxp:PanelContent>
                ...
                <table>
                    <tbody>
                        <tr>
                            <td>
                                <TSPControls:CustomAspxButton runat="server" Text=" " ToolTip="بازگشت" CausesValidation="False" ID="ASPxButton5" UseSubmitBehavior="False" EnableViewState="False" EnableTheming="False" OnClick="btnBack_Click">
                                    <hoverstyle backcolor="#FFE0C0">
<Border BorderWidth="1px" BorderStyle="Outset" BorderColor="Gray"></Border>
    ...
    <asp:ObjectDataSource ID="ObjdsWfReport" runat="server" TypeName="TSP.DataManager.WorkFlowStateManager" SelectMethod="SelectStateReportsById" OldValuesParameterFormatString="original_{0}">
        <SelectParameters>
