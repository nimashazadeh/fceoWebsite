<%@ Page Title="مشخصات عضو" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="EngOfficeMemberShow.aspx.cs" Inherits="Members_EngOfficeView_EngOfficeMemberShow" %>
		...
		e.isValid=true;
                                    ...
                                    <tr>
                                        ...
                                        <td dir="ltr" valign="top" align="right">
                                            <TSPControls:CustomAspxComboBox runat="server" Width="100%" TextField="OfpName" ID="drdPosition" 
                                    ...
                                    <tr>
                                        ...
                                        <td dir="ltr" valign="top" align="right">
                                            <TSPControls:CustomAspxComboBox runat="server" Width="100%"  ID="ComboTime" ValueType="System.String"
...
lblE.SetVisible(false);
                ...
                <TSPControls:CustomAspxDevGridView Width="100%" runat="server" 
                    ...
                    <Columns>
                        <dxwgv:GridViewDataTextColumn VisibleIndex="0" Width="100px" FieldName="GrdName"
                            Caption="پایه">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn VisibleIndex="1" Width="100px" FieldName="ResName"
                            Caption="صلاحیت">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn VisibleIndex="2" Width="100px" FieldName="MjName" Caption="رشته">
                        </dxwgv:GridViewDataTextColumn>
