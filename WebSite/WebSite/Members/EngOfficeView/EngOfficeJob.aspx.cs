...
public partial class Members_EngOfficeView_EngOfficeJob : System.Web.UI.Page
{
    ...
    protected void ASPxMenu1_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
    {
        switch (e.Item.Name)
        {
            ...
            case "EngOffice":
                Response.Redirect("EngOfficeMemberShow.aspx?EngOfId=" + EngOfficeId.Value + "&PageMode=" + PgMode.Value + "&EOfId=" + EngFileId.Value);
                break;
        }
    }
