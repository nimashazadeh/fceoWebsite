<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="CourseGroups.aspx.cs" Inherits="Members_Amoozesh_CourseGroups"
    Title="گروه بندی درس" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <br />
                <TSPControls:CustomAspxDevGridView ID="CustomAspxDevGridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <dxwgv:GridViewDataTextColumn FieldName="TgrId" Visible="False" VisibleIndex="0">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="نام گروه" FieldName="Name" VisibleIndex="0">
                        </dxwgv:GridViewDataTextColumn>
