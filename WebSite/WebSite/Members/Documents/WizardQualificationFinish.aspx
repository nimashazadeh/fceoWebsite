<%@ Page   Async="true"   Title="درخواست درج صلاحیت جید پروانه اشتغال-ثبت فیش" Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true" CodeFile="WizardQualificationFinish.aspx.cs" Inherits="Members_Documents_WizardQualificationFinish" %>
                                ...
                                <dxp:PanelContent>
                                    <div dir="rtl" align="right" style="line-height: 15pt">
                                        ...
                                        <ol dir="rtl" align="right">
                                            <li>جهت درج صلاحیت جدید پروانه نیازی به مراجعه و حضور در سازمان نمی باشد.</li>
                                            <li>نحوه پرداخت هزینه درج صلاحیت جدید پروانه فقط به صورت الکترونیکی و از طریق درگاه الکترونیکی
                                    ...
                                    <br />
                                    <p class="HelpUL">
                                        قابل ذکر است جهت پیگیری روند درخواست درج صلاحیت جدید خود از طریق همین سامانه و با استفاده از
