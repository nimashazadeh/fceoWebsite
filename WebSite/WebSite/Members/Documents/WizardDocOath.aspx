<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="WizardDocOath.aspx.cs" Inherits="Members_Documents_WizardDocOath" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelNezamRegister" runat="server">
        <ContentTemplate>
            ...
            <TSPControls:CustomASPxRoundPanel ID="RoundPanelMe" HeaderText="درخواست صدور پروانه اشتغال بکار مهندسی"
                ...
                <PanelCollection>
                    <dxp:PanelContent>
                            ...
                            <table width="100%">
                                <tr>
                                    <td align="right" valign="top" colspan="6">
                                        <p class="HelpUL">
                                            <b>قبل از شروع فرایند درخواست صدور پروانه اشتغال به چه مدارکی نیاز است و چه مواردی را
                                                                        باید بررسی کرد</b>
                                        </p>
                                        <ul style="font-family=tahoma;   line-height: 15pt">
                                            ...
                                            <li>پاسخ نامه تسویه حساب امور مالیاتی (گواهی موضوع ماده 186 قانون مالیات های مستقیم) جهت تهیه معرفی نامه سازمان نظام مهندسی به اداره امور مالیاتی به صفحه پورتال اعضا/لینک های پرکاربرد/چاپ نامه تسویه حساب امور مالیاتی مراجعه فرمایید</li>
                                        <li>گذراندن دوره آموزشي گذراندن دوره آموزشي HSE براي دارندگان پروانه اشتغال رشته عمران و معماري كه داراي صلاحيت اجرا مي باشند، الزامي گرديده است، براي رشته عمران تصویر آن فعلاً در قسمت مربوط به آپلود گواهي جوش ،آپلود شود اگر دوره جوش را آپلود كرده ايد اين تعهد كنار دوره جوش آپلود شود و در خصوص رشته معماري ، تصویر آن فعلاً در قسمت مربوط به آپلود مفاصاحساب مالياتي ،آپلود شود اگر مفاصاحساب مالياتي را آپلود كرده ايد اين تعهد كنار مفاصاحساب مالياتي آپلود شود.</li>
                                        </ul>
                                        <fieldset>
                                            ...
                                            <dl style="font-family=tahoma;  line-height: 15pt">
                                                <dt>روش تکمیل قسمت الف سابقه کار</dt>
                                            ...
                                            <dl style="font-family=tahoma;  line-height: 15pt">
                                                <dt>روش تکمیل قسمت ب سابقه کار</dt>
                                        ...
                                        <fieldset>
                                            ...
                                            <ul style="font-family=tahoma;  line-height: 15pt">
                                                <li>ثبت اطلاعات آزمونی که در آن شرکت و <u>موفق شده اید</u> الزامی می باشد.<b>(در
                                                                            صورتی که حوزه امتحانی شما غیر از استان فارس می باشد، در قسمت مربوط به آزمون، به
                                                                            جای آپلود کردن پرینت قبولی، نامه تائیدیه قبولی در آزمون از اداره کل راه و شهرسازی
                                                                            آن استان را آپلود نمایید.)</b> </li>
                                        ...
                                        <p style="font-family=tahoma; font-size: 8pt; line-height: 15pt">
                                            از آنجاییکه کلیه مراحل صدورپروانه اشتغال و یا نواقص پروانه ازطریق پیامک به شما اطلاع
                                                                    ...
                                                                    درضمن چون پیامکهای مربوط به نظام مهندسی جزء دسته پیامک های تبلیغاتی است درصورت غیرفعال
                                                                    کردن این دسته پیامک ها نسبت به فعال کردن پیامک های تبلیغاتی (دفترخدمات ارتباطی )
                                                                    خود اقدام کنید.
                                        </p>
                                        <p class="HelpUL">
                                        ...
                                        <p style="font-family=tahoma; font-size: 8pt; line-height: 15pt">
                                            از داخل همین صفحه لینک تغییرات اطلاعات پایه را انتخاب کنید و در داخل صفحه ای که
                                                                    ...
                                                                    عينک، کراوات و دیگر تزئینات خانمها: قرص صورت مشخص و با حجاب کامل
                                        </p>
                                        <p class="HelpUL">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td align="right" valign="top" width="50%">
                                                    <dxe:ASPxHyperLink ID="HpIdNo" runat="server" ClientInstanceName="HpIdNo" Target="_blank"
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" valign="top" dir="rtl">
                                                    <dxe:ASPxHyperLink ID="HpSoldire" runat="server" ClientVisible="false" ClientInstanceName="HpSoldire" Target="_blank"
                                ...
                                <tr>
                                    <td colspan="6" align="right" valign="top">
                                        ...
                                        <TSPControls:CustomAspxDevGridView2 runat="server" Caption="مدارک تحصیلی تایید شده در واحد عضویت"
                                            ...
                                            <SettingsBehavior AllowFocusedRow="false" ColumnResizeMode="Control" ConfirmDelete="True"></SettingsBehavior>
                        ...
                        <fieldset>
                            <legend class="fieldset-legend" dir="rtl"><b>تعهد نامه</b></legend>

                            <div align="right" dir="rtl">
                                <ol style="font-family=tahoma; font-size: 8pt; line-height: 15pt">
                                    با اذعان به اینکه برای نخستین بار است درخواست صدور پروانه اشتغال به کار مهندسی می
                                                            کنم و پیش از این از وزارت مسکن و شهرسازی در استانها و بنیاد مسکن انقلاب اسلامی استانها
                                                            ، پروانه اشتغال بکار(کاردانی یا کارشناسی یا روستایی)دریافت نکرده ام و مرجع صادر
                                                            کننده پروانه مجاز است در صورت مشاهده خلاف واقع ، پروانه صادر شده را باطل نموده و
                                                            تا هر زمان که لازم بداند از صدور پروانه اشتغال بکار مهندسی برای اینجانب خودداری
                                                            ورزد.با تکمیل فرم های مربوطه تقاضای صدور پروانه اشتغال بکار مهندسی در پایه سه را
                                                            می نمایم.
                                                            <br />
                                </ol>
                            </div>
                        ...
                        <fieldset>
                            <legend class="fieldset-legend" dir="rtl"><b>سوگند نامه</b></legend>

                            <div align="right" dir="rtl">
                                <ol style="font-family=tahoma; font-size: 8pt; line-height: 15pt">
                                    <b>من در پیشگاه خداوند متعال،سوگند یاد می کنم : </b>
                                    <br />
                                    در مقام یک مهندس،در تمام فعالیت های حرفه ای خود،صداقت،دقت،نظم،حفظ منافع اجتماع و
                                                            رعایت حقوق همگان را سرلوحه ی کار خود بدانم،ایمنی،سلامت و آینده ی انسان ها را در
                                                            نظر بگیرم و منافع مردم را برتر از همه ی تمایلات خویش قرار دهم.
                                                            <br />
                                    در حرفه ی مهندسی پویا بوده و تنها توانمندی حرفه ای را شرط رقابت قرارداده،حیثیت و
                                                            اعتبار دیگران را محترم شمارم.
                                                            <br />
                                    بکوشم که دین خود را نسبت به کشورم اداکنم و در انجام وظایف حرفه ای،متعهد و مسئولیت
                                                            پذیر باشم.
                                                            <br />
                                    قوانین و مقررات را محترم شمرده و اصول اخلاق مهندسی و وجدان حرفه ای را رعایت کنم.
                                </ol>
                            </div>
                        </fieldset>
                        ...
                        <table width="100%">
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div align="right" dir="rtl">
                                        <TSPControls:CustomASPxCheckBox Font-Bold="true" CssClass="continueLink" runat="server" Text="اینجانب اعلام می نمایم سوگند نامه را مطالعه نموده ام  و با اگاهی به همه موارد فوق موافقت خود را اعلام می دارم هچنین متعهد می گردم که چارچوب تعیین شده را در طول فعالیتهای حرفه ای خود مدنظر داشته و به آن عمل نمایم."
