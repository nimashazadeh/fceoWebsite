<%@ Page     Async="true"   Title="درخواست صدور پروانه اشتغال-ثبت نهایی"Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="WizardDocFinish.aspx.cs" Inherits="Members_Documents_WizardDocFinish" %>
                    ...
                    <dxp:PanelContent>
                        <div dir="rtl" align="right" style="line-height: 15pt">
                            ...
                            <ol dir="rtl" align="right">
                                <li>جهت صدور پروانه نیازی به مراجعه و حضور در سازمان نمی باشد.</li>
                                <li>نحوه پرداخت هزینه صدور پروانه فقط به صورت الکترونیکی و از طریق درگاه الکترونیکی
                        ...
                        <br />
                        <p class="HelpUL">
                            قابل ذکر است جهت پیگیری روند درخواست صدور خود از طریق همین سامانه و با استفاده از
