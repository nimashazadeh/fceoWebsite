<%@ Page Title="درخواست صدور پروانه اشتغال-آزمون ها" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="WizardDocExam.aspx.cs" Inherits="Members_Documents_WizardDocExam" %>
        ...
        <ContentTemplate>
            <script language="javascript" type="text/javascript">
                ...
                function ClearHSE() {
                    ...
                    HiddenFieldDocMemberFile.Set('HSEImg', 0);
                }
            ...
            <p>
                ...
                <ul class="HelpUL">
                    ...
                    <li>نمره هر یک از زمینه های آزمونی که در آن شرکت و موفق شده اید راوارد و سپس دکمه اضافه
                                        ...
                                        را تکرار نمایید. </li>
                    <li>در صورت قبولی در آزمون آبان 93 به بعد , متقاضی درج صلاحیت اجرا می باشید، علاوه بر تصویر کارنامه آزمون، تصویر گواهینامه دوره آموزشی ورود به حرفه اجرا نیز الزامی می باشد</li>
                </ul>
                                                ...
                                                <tr>
                                                    <td>
                                                        <TSPControls:CustomAspxUploadControl ID="flpConfAttach" runat="server" ClientInstanceName="flpi"
                                                            UploadWhenFileChoosed="true" InputType="Files" OnFileUploadComplete="flpConfAttach_FileUploadComplete">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <TSPControls:CustomAspxUploadControl ID="UploadControlPeriodImgURL" runat="server" ClientInstanceName="UploadControlPeriodImgURL"
                                                                        UploadWhenFileChoosed="true" InputType="Files" OnFileUploadComplete="UploadControlPeriodImgURL_FileUploadComplete">
                                                                        <ClientSideEvents FileUploadComplete="function(s, e) {
                                                                    if(e.isValid){
