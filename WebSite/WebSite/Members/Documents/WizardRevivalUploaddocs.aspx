<%@ Page Title="درخواست تمدید پروانه اشتغال-استعلام ها" Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true" CodeFile="WizardRevivalUploaddocs.aspx.cs" Inherits="Members_Documents_WizardRevivalUploaddocs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <ul class="HelpUL">
                ...
                <li>فرم استعلام از اداره امور مالیاتی را از قسمت لینک های پرکاربرد در صفحه ورود به پرتال چاپ نمایید و پس از تایید اداره امور مالیاتی بارگذاری نمایید</li>
                ...
                <li>در صورتی که دوره جوش را تا به حال نگذرانده اید از قسمت آرشیو فرم ها، فرم تعهد یک ساله را تکمیل و آپلود نمایید. (تنها یک بار می توانید در صورت نگذراندن دوره جوش پروانه با اعتبار یک ساله را درخواست نمایید.)
                </li>
                <li>بارگذاری تصویر نامه یا فرم تاییدیه عدم عضویت در نظام کاردانی برای آن دسته از متقاضیان داری مدرک کارشناسی ناپیوسته 
                                        الزامی می باشد</li>
	...
	imgTaxOfficeLetter.SetImageUrl('../../Images/noimage.gif');
	}
}" />
                            ...
                            <tr>
                                <td colspan="2">
                                    <ul runat="server" id="lblWarningPeriod" style="font-family=tahoma; font-size: 8pt; line-height: 15pt; color: DarkRed">

                                        <li>اعضای دارای پروانه اشتغال 1 ساله، در صورتی که صدور پروانه 1 ساله به دلیل عدم ارائه کارت پایان خدمت به سازمان بوده است، نیاز به آپلود تصویر گواهی دوره جوشکاری نمی باشند.
                                        </li>
                                    </ul>
                                </td>
	...
	imgFrontDoc.SetImageUrl('../../Images/noimage.gif');
	}
}" />
                                                    </TSPControls:CustomAspxUploadControl>
	...
	imgBackDoc.SetImageUrl('../../Images/noimage.gif');
	}
}" />
                                                    </TSPControls:CustomAspxUploadControl>
