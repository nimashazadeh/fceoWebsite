<%@ Page Title="درخواست ارتقاء پایه پروانه اشتغال-تاییدیه سوابق کاری" Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true" CodeFile="WizardUpgradeJobConfirm.aspx.cs" Inherits="Members_Documents_WizardUpgradeJobConfirm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function SetConfimVisible() {
            if (cmbConfirmType.GetValue() == 0) {
                ...
                ImageGrd.SetImageUrl('~/Images/noimage.gif');
        ...
        <ContentTemplate>
            ...
            <TSPControls:CustomAspxMenuHorizontal ID="MenuSteps" runat="server">
                <Items>
                    ...
                    <dxm:MenuItem Name="JobConfirm" Text="تاییدیه سابق کاری" Selected="true">
                    </dxm:MenuItem>
            ...
            <ul class="HelpUL">
                ...
                <ol>
                    ...
                    <ul>
                        <li>الف)شرکت دارای پروانه اشتغال حقوقی از سازمان نظام مهندسی فارس می باشد، در این صورت بارگزاری
                                            تصویر پروانه شرکت حقوقی الزامی است. </li>
                        <li>ب)شرکت دارای پروانه اشتغال حقوقی از سازمان نظام مهندسی فارس نمی باشد، در این صورت
              ...
              <li>
                  <b>مدت زمان مورد نیاز سابقه کار بعد از فراغت از تحصیل برای متقاضیان پایه سه با توجه
                                                                            به مقطع تحصیلی به صورت زیر می باشد</b>
                  
                 </li>  <ul>
                                                <li>ارتقا پایه سه به دو و دارای مدرک کارشناسی: 7 سال کامل بعد از فارغ التحصیلی كارشناسی (درصورتی كه قبلاً 7 سال سابقه كار را ارائه داده اید ، نیازی به ارائه سابقه كار نیست)</li>
                                                <li>ارتقا پایه سه به دو و دارای مدرک کارشناسی ارشد: 6 سال کامل بعد از فارغ التحصیلی كارشناسی نیاز می باشد(درصورتی كه قبلاً 6 سال سابقه كار را ارائه داده اید، نیازی به ارائه سابقه كار نیست)</li>
                                                <li>ارتقا پایه سه به دو و دارای مدرک دکترا: 5 سال کامل بعد از فارغ التحصیلی كارشناسی نیاز می باشد(درصورتی كه قبلاً 5 سال سابقه كار را ارائه داده اید، نیازی به ارائه سابقه كار نیست)</li>

                                                <li>ارتقا پایه دو به یک و دارای مدرک کارشناسی: 12 سال کامل بعد از فارغ التحصیلی كارشناسی نیاز می باشد(درصورتی كه قبلاً 12 سال سابقه كار را ارائه داده اید، نیازی به ارائه سابقه كار نیست)</li>
                                                <li>ارتقا پایه دو به یک و دارای مدرک کارشناسی ارشد: 11 سال کامل  بعد از فارغ التحصیلی كارشناسی نیاز می باشد(درصورتی كه قبلاً 11 سال سابقه كار را ارائه داده اید، نیازی به ارائه سابقه كار نیست)</li>
                                                <li>ارتقا پایه دو به یک و دارای مدرک دکترا: 10 سال کامل بعد از فارغ التحصیلی كارشناسی نیاز می باشد(درصورتی كه قبلاً 10 سال سابقه كار را ارائه داده اید، نیازی به ارائه سابقه كار نیست)</li>
                                          
             </ul>
            </ul>
              
            <fieldset>
                <legend class="fieldset-legend" dir="rtl"><b>سابقه کارهای ثبت شده در درخواست های تایید شده پروانه</b></legend>
                <ul class="HelpUL">
                    <li>توجه نمایید در محاسبه تعداد سال های سابقه کار همپوشانی در نظر گرفته نمی شود.لذا در ثبت تاریخ سابقه کار به لیست سابقه کار های ثبت شده در درخواست های تایید شده پیشین(لیست زیر)دقت نمایید </li>
                </ul>
                    ...
                    <dxp:PanelContent>
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td align="right" valign="top">نوع مسئولیت در پروژه(سمت)* :
                                </td>
                            ...
                            <tr>
                                <td width="20%" align="right" valign="top">
                                    <dxe:ASPxLabel runat="server" Text="نام پروژهها و محل اجرای کارهای انجام شده" ID="lblDescription" ClientInstanceName="lblDescription"
                                        Width="100%">
                                    </dxe:ASPxLabel>
                                </td>
                                <td colspan="3">
                                    ...
                                    <dxe:ASPxLabel runat="server" Text="به صورت خلاصه نام پروژه ها و محل اجرای کارهای انجام شده را وارد نمایید.  "
                            ...
                            <tr>
                                <td valign="top" align="right">
                                    <asp:Label runat="server" Text="تصویر فرم سابقه کار*" ID="Label50"></asp:Label>
                                </td>
	...
	ImageConf.SetImageUrl('');
                            ...
                            <tr>
                                <td valign="top" align="right">
                                    <dxe:ASPxLabel runat="server" Text="تصویر پروانه حقوقی یا گواهی رتبه بندی شرکت*" ClientInstanceName="lblGrid"
                                        ID="lblGrid">
                                    </dxe:ASPxLabel>
                                </td>
                                <td valign="top" align="right" colspan="3">
 ...
 if(confirm('آیا مطمئن به پاک کردن اطلاعات فرم هستید؟'))
	SetEmpty();
                                ...
                                <td colspan="4">
                                    <TSPControls:CustomAspxDevGridView2 ID="GrdvJobCon" runat="server" Width="100%" EnableCallBacks="True"
                                        ...
                                        <Columns>
                                            ...
                                            <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="DateFrom" Caption="از تاریخ"
                                                Name="ProjectName">
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="DateTo" Caption="تا تاریخ"
                                                Name="ProjectName">
                                            </dxwgv:GridViewDataTextColumn>
            ...
            <div class="Item-center">
                ...
                <asp:LinkButton ID="btnNext" CssClass="ButtonMenue" OnClick="btnNext_Click" runat="server" CausesValidation="false">تایید و ادامه</asp:LinkButton>
            </div>
