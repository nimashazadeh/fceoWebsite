...
public partial class Members_Office_OfficeJobShow : System.Web.UI.Page
{
    ...
    protected void ASPxMenu1_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
    {
        ...
        {
            case "JobQuality":
                Response.Redirect("OfficeJobQuality.aspx?OfId=" + OfficeId.Value + "&OfReId=" + OfficeRequest.Value + "&JhId=" + JobId.Value);
