<%@ Page Language="C#" MasterPageFile="~/MasterPageWebsite.master" AutoEventWireup="true"
    CodeFile="WizardMemberJob.aspx.cs" Inherits="NezamRegister_WizardMemberJob" Title="عضویت حقیقی - سوابق کاری" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
                    ...
                    <table width="100%">
                        <tr>
                            <td align="right" style="width: 20%; height: 28px" valign="middle">
                                <dxe:ASPxLabel ID="ASPxLabel9" runat="server" Text="سوابق کاری" Font-Bold="true">
                                </dxe:ASPxLabel>
                            </td>
                            <td align="left" style="width: 80%; height: 30px" valign="middle">
                                <TSPControls:CustomAspxButton AutoPostBack="false" ID="btnHelp" runat="server" CausesValidation="False"
                                    EnableTheming="False" EnableViewState="False"
                                    Text=" " ToolTip="راهنما" UseSubmitBehavior="False" IsMenuButton="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <TSPControls:CustomAspxComboBox runat="server" Width="100%"
                                    RightToLeft="True" TextField="Name" ID="CombojPrType"
                                    DataSourceID="OdbPrType" ValueType="System.String" ValueField="PrtId"
                                    EnableIncrementalFiltering="true" ClientInstanceName="CmbPrType">
	...
	lbl3.SetVisible(false);
                            ...
                            <div class="col-md-3">نوع سازه</div>
                            <div class="col-md-3">
                                <TSPControls:CustomAspxComboBox runat="server" Width="100%" EnableIncrementalFiltering="true" RightToLeft="True"
                                    TextField="Name"
                                    ID="CombojSazeType" DataSourceID="OdbSazeType" ValueType="System.String"
                                    ValueField="SztId" ClientInstanceName="CmbSazeType"
                                    ClientVisible="False">
                                    <ValidationSettings ValidateOnLeave="False" Display="Dynamic" ValidationGroup="j"
                                        ErrorTextPosition="Bottom">
                                        <ErrorImage Height="14px" Url="~/App_Themes/Glass/Editors/edtError.png">
	...
	lbl2.SetVisible(false);
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <TSPControls:CustomAspxComboBox EnableIncrementalFiltering="true" runat="server" Width="100%" RightToLeft="True"
                                    TextField="CounName"
                                    ID="CombojCountry" DataSourceID="ODBJobCountry" ValueType="System.String"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <pdc:PersianDateValidator runat="server" ValidateEmptyText="True" ClientValidationFunction="PersianDateValidator"
                                    ...
                                    ForeColor="Red" ID="PersianDateValidator1">تاریخ را انتخاب نمایید</pdc:PersianDateValidator>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <pdc:PersianDateValidator runat="server" ValidateEmptyText="True" ClientValidationFunction="PersianDateValidator"
                                    ...
                                    ForeColor="Red" ID="PersianDateValidator2">تاریخ را انتخاب نمایید</pdc:PersianDateValidator>
                                <br />
                            ...
                            <div class="col-md-3">
                                ...
                                <pdc:PersianDateValidator runat="server" ValidateEmptyText="True" ClientValidationFunction="PersianDateValidator"
                                    ...
                                    ID="PersianDateValidator3" ForeColor="Red">تاریخ را انتخاب نمایید</pdc:PersianDateValidator>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-3">زیربنا *</div>
                            <div class="col-md-3">
                                <TSPControls:CustomTextBox runat="server" ClientVisible="False" Width="100%"
                                    ID="txtjArea" ClientInstanceName="TextArea" MaxLength="10">
                            ...
                            <div class="col-md-3">تعداد طبقات*</div>
                            <div class="col-md-3">
                                <TSPControls:CustomTextBox runat="server" ClientVisible="False" Width="100%"
                                    ID="txtjFloor" ClientInstanceName="TextFloor" MaxLength="5">
                                    <ValidationSettings Display="Dynamic" ValidationGroup="j" ErrorTextPosition="Bottom">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <TSPControls:CustomASPXMemo runat="server" Height="50px" Width="100%" ID="txtjDesc"
