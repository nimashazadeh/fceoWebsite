<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="FormsType.aspx.cs" Inherits="Employee_HomePage_FormsType"
    Title="مدیریت نوع فرم" %>
...
if (grid.GetFocusedRowIndex()&lt;0)
 {
   ...
   alert(&quot;ردیفی انتخاب نشده است&quot;);
	 ...
	 e.processOnServer= confirm('آیا مطمئن به غیر فعال کردن این ردیف هستید؟');
            ...
            <br />
            <TSPControls:CustomAspxDevGridView ID="GridViewFormsType" runat="server" AutoGenerateColumns="False"
                  DataSourceID="ObjdsFormsType"
                KeyFieldName="FormTypeId" Width="100%" ClientInstanceName="grid">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="عنوان نوع" FieldName="FormTypeName" VisibleIndex="0">
            ...
            </TSPControls:CustomAspxDevGridView>  <asp:ObjectDataSource ID="ObjdsFormsType" runat="server" SelectMethod="GetData" TypeName="TSP.DataManager.FormsTypeManager"></asp:ObjectDataSource>
            <br />
