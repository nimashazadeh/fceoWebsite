...
public partial class Employee_HomePage_Podcast : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            TSP.DataManager.Permission per = TSP.DataManager.HomePageAttachmentManager.GetUserPermissionPodcasts(Utility.GetCurrentUser_UserId(), (TSP.DataManager.UserType)Utility.GetCurrentUser_LoginType());
            ...
            ObjSiteImage.SelectParameters["ImageType"].DefaultValue = ((int)TSP.DataManager.SiteImageManager.SiteImageType.Voice).ToString();
    ...
    private void InsertImage(DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        try
        {
            ...
            Row["InActive"] = 0;
            Row["ImageType"] = (int)(TSP.DataManager.SiteImageManager.SiteImageType.Voice);
