...
public partial class Employee_HomePage_Forms : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AddForm.aspx?FoId=" + Utility.EncryptQS("") + "&PageMode=" + Utility.EncryptQS("New"));
    }
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("AddForm.aspx?FoId=" + Utility.EncryptQS(FoId.ToString()) + "&PageMode=" + Utility.EncryptQS("Edit"));
        }
    }
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("AddForm.aspx?FoId=" + Utility.EncryptQS(FoId.ToString()) + "&PageMode=" + Utility.EncryptQS("View"));
        }
    }
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            TSP.DataManager.FormsManager managerEdit = new TSP.DataManager.FormsManager();
            managerEdit.FindByCode(FoId);
