<%@ Page Title="مشخصات نوع فرم" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="AddFormsType.aspx.cs" Inherits="Employee_HomePage_AddFormsType" %>
                ...
                <table dir="rtl" width="100%">
                    <tr>
                        <td align="right" valign="top" style="width: 15%">
                            <dxe:ASPxLabel ID="ASPxLabel1" runat="server" Text="عنوان نوع فرم *">
                            </dxe:ASPxLabel>
                        </td>
                        <td align="right" valign="top" style="width: 35%">
                            <TSPControls:CustomTextBox IsMenuButton="true" ID="txtFormTypeName" runat="server" Width="100%">
