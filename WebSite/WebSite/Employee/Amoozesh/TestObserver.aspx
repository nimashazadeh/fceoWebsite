<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPagePortals.master" CodeFile="TestObserver.aspx.cs" Inherits="Employee_Amoozesh_Observer" Title="ناظرین آزمون" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
	 ...
	 e.processOnServer= confirm('آیا مطمئن به حذف این ردیف هستید؟');
                    ...
                    <TSPControls:CustomAspxDevGridView ID="CustomAspxDevGridView1" runat="server" AutoGenerateColumns="False"
                        DataSourceID="OdbTestObserver" KeyFieldName="TOId" Width="100%">
                        
                        <Columns>
                            <dxwgv:GridViewDataTextColumn Caption="کد" FieldName="TOId" Visible="False" VisibleIndex="0">
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="نام" FieldName="Name" VisibleIndex="1"
                                Width="60px">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="نام خانوادگی" FieldName="Family" VisibleIndex="2"
                                Width="100px">
                            </dxwgv:GridViewDataTextColumn>
	 ...
	 e.processOnServer= confirm('آیا مطمئن به حذف این ردیف هستید؟');
                    ...
                    <asp:ObjectDataSource ID="OdbTestObserver" runat="server" SelectMethod="GetData" TypeName="TSP.DataManager.TestObserverManager" FilterExpression="TestId={0}">
                        <FilterParameters>
