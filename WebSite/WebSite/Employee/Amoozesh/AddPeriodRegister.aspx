                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <TSPControls:CustomAspxButton IsMenuButton="true" ID="btnSave" runat="server" AutoPostBack="False"
                                                ...
                                                ToolTip="ذخیره" UseSubmitBehavior="False">

                                                <Image Url="~/Images/icons/save.png" />
                                            </TSPControls:CustomAspxButton>
                                        </td>
                                        <td>
                                            <TSPControls:CustomAspxButton IsMenuButton="true" ID="btnAutoSave" runat="server" EnableTheming="False"
                                                EnableViewState="true" OnClick="btnAutoSave_Click" Text=" " ToolTip="ذخیره گواهینامه و تایید اتوماتیک گردش کار"
                                                UseSubmitBehavior="False">
                                                <ClientSideEvents Click="function(s,e){     
                                                                                  
                                                        e.processOnServer=confirm('آیا از ذخیره گواهینامه و تایید اتوماتیک گردش کار مطمئن می باشید؟');                            
                                                 }" />

                                                <Image Url="~/Images/icons/AutoRequest.png" />
                                            </TSPControls:CustomAspxButton>
                                        </td>
...
else
{
                                        ...
                                        <td dir="rtl" valign="top" align="right" colspan="3">
                                            <TSPControls:CustomTextBox runat="server" Width="100%"
                                                ...
                                                <ValidationSettings ErrorDisplayMode="Text" Display="Dynamic"
                                                                ErrorTextPosition="Bottom">
                                                    <RequiredField IsRequired="True" ErrorText="پایه و صلاحیت را وارد نمایید."></RequiredField>                                                              
                                                    <ErrorFrameStyle ImageSpacing="4px">
                                                        <ErrorTextPaddings PaddingLeft="4px"></ErrorTextPaddings>
                                                    </ErrorFrameStyle>
                                                </ValidationSettings>                                               
	...
	popUpPeriods.Show();
                                                                ...
                                                                <ValidationSettings ErrorTextPosition="Bottom">
                                                                    ...
                                                                    <RequiredField IsRequired="True" ErrorText="دوره را انتخاب نمایید"></RequiredField>
                                                                </ValidationSettings>
                                                            </TSPControls:CustomTextBox>
                                                        </td>
                                                        <td align="right" valign="top" width="5%">
                                                            <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" AutoPostBack="False" UseSubmitBehavior="False" EnableClientSideAPI="True"
                                                                ...
                                                                ToolTip="جستجو" ID="btnSearchPeriod" EnableViewState="False">
                                                                <ClientSideEvents Click="function(s, e) {
	popUpPeriods.Show();
}"></ClientSideEvents>
                                        ...
                                        <td valign="top" align="right">
                                            <TSPControls:CustomAspxComboBox runat="server" SelectedIndex="2" ValueType="System.String" Width="100%"
                                                ...
                                                <Items>
                                                    ...
                                                    <%--    <dxe:ListEditItem Text="خارج از نوبت" Value="2" Selected="True"></dxe:ListEditItem>--%>
                                                </Items>
                                                <ValidationSettings>
                                                    <ErrorImage Height="14px" Url="~/App_Themes/Glass/Editors/edtError.png">
                                                    </ErrorImage>
                                    ...
                                    <tr>
                                        <td colspan="6" valign="top" align="center">
                                            <br />
                                            <fieldset>
                                                <legend class="HelpUL">مشخصات پرداخت</legend>
                                                <dx:ASPxPanel ID="RoundPanelAccounting" ClientInstanceName="RoundPanelAccounting"
                                                    runat="server">
                                                    <PanelCollection>
                                                        <dx:PanelContent>
                                                            <table width="100%">
	...
	if(aType.GetValue()=='1')
		...
		SetPose();
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <TSPControls:CustomAspxButton IsMenuButton="true" ID="btnAutoSave2" runat="server" EnableTheming="False"
                                                EnableViewState="true" OnClick="btnAutoSave_Click" Text=" " ToolTip="ذخیره گواهینامه و تایید اتوماتیک گردش کار"
                                                UseSubmitBehavior="False">
                                                <ClientSideEvents Click="function(s,e){     
                ...
                <TSPControls:CustomASPxPopupControl ID="ASPxPopupControl2" runat="server" Width="750px"
                    HeaderText="جستجو" Height="269px"
                    ClientInstanceName="popUpPeriods" CloseAction="CloseButton"
