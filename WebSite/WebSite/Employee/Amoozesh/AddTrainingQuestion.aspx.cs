...
public partial class Employee_Amoozesh_AddTrainingQuestion : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        btnBack.PostBackUrl = "TrainingQuestions.aspx";
        ASPxButton6.PostBackUrl = "TrainingQuestions.aspx";
    ...
    protected string SaveImage(UploadedFile uploadedFile)
    {
        ...
        if (uploadedFile.IsValid)
        {
            ...
            Session["QuFileUpload"] = tempFileName;
        }
        return ret;
    }
    ...
    protected void Insert()
    {
        ...
        try
        {
            ...
            drQu["CreateDate"] = PerDate;
            drQu["UserId"] = Utility.GetCurrentUser_UserId();
            drQu["ModifiedDate"] = DateTime.Now;

            if (Session["QuFileUpload"] != null)
            {
                drQu["FileUrl"] = "~/Image/Employee/Amoozesh/TrainingQuestions/" + System.IO.Path.GetFileName(Session["QuFileUpload"].ToString());
            }
