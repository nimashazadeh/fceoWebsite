...
using System.IO;
public partial class Employee_Amoozesh_AddTestAttenders : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ODBPeriodAttender.FilterParameters[0].DefaultValue = PPID;
            ...
            TSP.DataManager.TestAttenderManager mngDelete = new TSP.DataManager.TestAttenderManager();
        ...
        if (manager.Count > 0)
        {
            ...
            if ((CustomAspxDevGridView1.VisibleRowCount > 0) && (manager.Count > 0))
            {
                ...
                for (int i = 0; i < CustomAspxDevGridView1.VisibleRowCount; i++)
                {
                    ...
                    {
                        if (manager[j]["PAId"].ToString() == row1["PAId"].ToString())
                        {
        ...
        if (!string.IsNullOrEmpty(PPId.ToString()) && !string.IsNullOrEmpty(TestId.ToString()))
        {
            ...
            catch (Exception err)
            {
                ...
                if (err.GetType() == typeof(System.Data.SqlClient.SqlException))
                {
                    ...
                    {
                        this.DivReport.Visible = true;
                        this.LabelWarning.Text = "شخص مورد نظر قبلاً در این آزمون شرکت کرده.";
                    }
                    else
                    {
                        this.DivReport.Visible = true;
