...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <PanelCollection>
                    <dxp:PanelContent>
                        ...
                        <table width="100%">
                            <tbody>
                                <tr>
                                    <td  style="vertical-align: top"  align="center" colspan="4">
                                        <dxe:ASPxLabel runat="server" Text="وضعیت جریان کار" ID="lblWorkFlowState" ForeColor="Red"></dxe:ASPxLabel>
                                    </td>
                                </tr>
                                <tr>   <td  width="15%" valign="top" align="right">
                                        <asp:Label runat="server" Text="کد عضویت *" Width="83px" ID="Label2"></asp:Label>

                                    </td>
                                    <td width="35%"  valign="top" align="right" >
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server" ID="txtMeNo" AutoPostBack="True"  ClientInstanceName="TextName" OnTextChanged="txtMeNo_TextChanged">
                                ...
                                <tr>   <td valign="top" align="right">
                                    ...
                                    <td  valign="top" align="right">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server" ID="txtName" ReadOnly="True"  ClientInstanceName="TextName">
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom">
                                                <ErrorImage Height="14px" Url="~/App_Themes/Glass/Editors/edtError.png"></ErrorImage>
                                    ...
                                    <td  valign="top" align="right">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server" ID="txtFamily" ReadOnly="True"  ClientInstanceName="TextName">
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom">
                                                <ErrorImage Height="14px" Url="~/App_Themes/Glass/Editors/edtError.png"></ErrorImage>
                            ...
                            <PanelCollection>
                                <dxp:PanelContent>
                                    <table width="100%">
                                        <tbody>
                                            <tr> <td width="15%"  valign="top" align="right">
                                                    <asp:Label runat="server" Text="نام مقاله/ فعالیت آموزشی *"  ID="Label50"></asp:Label>
                                                </td>
                                                <td width="35%" valign="top" align="right">
                                                    <TSPControls:CustomTextBox IsMenuButton="true" runat="server" ID="txtResearch"  ClientInstanceName="TextName">
                                                        <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom">
                                                            <ErrorImage Height="14px" Url="~/App_Themes/Glass/Editors/edtError.png"></ErrorImage>
                                            ...
                                            <tr> <td valign="top" align="right">
                                                    <asp:Label runat="server" Text="نوع مقاله/ فعالیت آموزشی"  ID="Label48"></asp:Label>
                                                </td>
                                                <td valign="top" align="right">
                                                    <TSPControls:CustomAspxComboBox runat="server"  TextField="RaName" ID="cmbResearch" DataSourceID="ODBResearch" ValueType="System.String" ValueField="RaId" ClientInstanceName="ComboType">
                                                        <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom">
                                            ...
                                            <tr> <td  valign="top" align="right">
                                                ...
                                                <td  valign="top" align="right">
                                                    <TSPControls:CustomASPXMemo runat="server" Height="37px" ID="txtResearchDesc"  ClientInstanceName="TextDesc"></TSPControls:CustomASPXMemo>
                        ...
                        <br />
                        <TSPControls:CustomAspxCallbackPanel runat="server" ID="CallbackPanelReq" ClientInstanceName="CallbackPanelReq" OnCallback="CallbackPanelReq_Callback">
                            <PanelCollection>
	...
	CallbackPanelReq.PerformCallback('CheckLetter'+';'+txtMailNo.GetText());
                                                            ...
                                                            <td id="TD3" runat="server" style="width: 86px"  valign="top" align="right">
                                                                <dxe:ASPxLabel runat="server" Text="تاریخ نامه" ID="ASPxLabel13" ClientInstanceName="lblDate"></dxe:ASPxLabel>


                                                            </td>
                                                            <td id="TD4" runat="server"  valign="top" align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td  valign="top" align="right" colspan="3">
                                                                <TSPControls:CustomTextBox IsMenuButton="true" runat="server" ID="txtJudgGrad"  ClientInstanceName="TextName">
                                                                    <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom">
                                                                        <ErrorImage Height="14px" Url="~/App_Themes/Glass/Editors/edtError.png"></ErrorImage>
                    ...
                    <dxp:PanelContent>
                        ...
                        <table style="display: block; overflow: hidden; border-collapse: collapse" cellpadding="0"
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <dxhf:ASPxHiddenField runat="server" ID="HiddenFieldResearch">
            ...
            <asp:ObjectDataSource ID="ODBResearch" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="TSP.DataManager.ResearchActivityManager" UpdateMethod="Update"></asp:ObjectDataSource>
        </ContentTemplate>
    </asp:UpdatePanel>
