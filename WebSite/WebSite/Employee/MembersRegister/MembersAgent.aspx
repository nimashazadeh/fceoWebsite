<%@ Page Title="درخواست تغییرات دفتر نمایندگی اعضا" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="MembersAgent.aspx.cs" Inherits="Employee_MembersRegister_MembersAgent" %>
                    ...
                    <dxp:PanelContent>
                        <table dir="rtl">
                            <tbody>
                                <tr>
                                    <td>
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" "  ToolTip="درخواست تغییر نمایندگی"
                                            ID="btnEdit" UseSubmitBehavior="False" EnableViewState="False" EnableTheming="False"
                                            AutoPostBack="false" OnClick="btnEdit_Click">
	...
	if (grid.GetFocusedRowIndex()&lt;0)
 {
   ...
   alert(&quot;ردیفی انتخاب نشده است&quot;);
	...
	grid.PerformCallback('Print');
            ...
            <br />      <TSPControls:CustomASPxRoundPanel ID="RoundPanelSearch" HeaderText="جستجو" runat="server"
                Width="100%">
                <PanelCollection>
                    <dxp:PanelContent>
                        <table width="100%">
                            <tr>
                                ...
                                <td style="width: 35%">
                                    <TSPControls:CustomAspxComboBox runat="server"  Width="100%" 
                                         TextField="Name" ID="cmbAgent" DataSourceID="OdbAgent"
                                        RightToLeft="True" ValueType="System.String" ValueField="AgentId" ClientInstanceName="cmbAgent"
                            ...
                            <td></td>
                                <td align="left" valign="top">
                                    <TSPControls:CustomAspxButton   runat="server" Text="جستجو"  ID="btnSearch" AutoPostBack="False"
                                        ...
                                        <ClientSideEvents Click="function(s, e) {
	if(txtFamily.GetText()=='' && txtName.GetText()=='' && txtMeId.GetText()=='' && cmbAgent.GetSelectedIndex()==-1)
    {
    ...
    e.processOnServer=true;
            ...
            <TSPControls:CustomAspxDevGridView ID="GridViewMember" runat="server" Width="100%"
                DataSourceID="ObjectDataSourceMember" KeyFieldName="MeId"  
                AutoGenerateColumns="False" ClientInstanceName="grid" OnCustomCallback="GridViewMember_CustomCallback">
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="AgentName" Width="200px"
                        Caption="نمایندگی">
                        ...
                        <div align="center">
                            <TSPControls:CustomAspxDevGridView ID="CustomAspxDevGridViewRequest" runat="server"
                                ClientInstanceName="Reqgrid" AutoGenerateColumns="False" 
                                 KeyFieldName="MReId" Width="100%" OnBeforePerformDataSelect="CustomAspxDevGridViewRequest_BeforePerformDataSelect"
	...
	if (grid.GetFocusedRowIndex()&lt;0)
 {
   ...
   alert(&quot;ردیفی انتخاب نشده است&quot;);
	...
	grid.PerformCallback('Print');
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceMember" runat="server" SelectMethod="SelectMemberForAgent"
                TypeName="TSP.DataManager.MemberManager"> <SelectParameters>
            ...
            <asp:ObjectDataSource ID="OdbRequest" runat="server" SelectMethod="SelectMemberRequestForAgent"
