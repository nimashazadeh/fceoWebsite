<%@ Page Title="گزارش چاپ درخواست های استعلام مدرک تحصیلی" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="ReportMemberLicenceInquery.aspx.cs" Inherits="Employee_MembersRegister_ReportMemberLicenceInquery" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <TSPControls:CustomAspxDevGridView ID="GridView" runat="server" AutoGenerateColumns="False"
    ...
    <asp:ObjectDataSource ID="objdsPrintingHistory" runat="server" TypeName="TSP.DataManager.PrintingHistoryManager"
        ...
        <SelectParameters>
            ...
            <asp:Parameter DbType="Int32" DefaultValue="-1" Name="TableTypeInquery" />
        </SelectParameters>
