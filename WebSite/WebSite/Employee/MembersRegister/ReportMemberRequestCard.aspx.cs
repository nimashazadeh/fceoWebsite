...
public partial class Employee_MembersRegister_ReportMemberRequestCard : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            TSP.DataManager.Permission perCardRequest = TSP.DataManager.MemberManager.GetUserPermissionForReportMemberCardRequest(Utility.GetCurrentUser_UserId(),
        ...
        objdsPrintingHistory.SelectParameters["TableType"].DefaultValue = ((int)TSP.DataManager.TableType.MemberCardRequestPrint).ToString();
    ...
    {
        GridViewExporter.FileName = "MemberCardRequestPrintingHistory";
        ...
        if (!string.IsNullOrEmpty(e.Parameters))
        {
            switch (e.Parameters)
            {
                case "Print":
                    ...
                    Session["Title"] = "گزارش چاپ درخواست های کارت عضویت";
                    break;
            }
        }
    }
