<%@ Page Title="درخواست قطع عضویت" Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true" CodeFile="CancelMembership.aspx.cs" Inherits="Employee_MembersRegister_CancelMembership" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <dxp:PanelContent>
                        <table dir="rtl">
                            <tbody>
                                <tr>
                                    <td>
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="درخواست قطع عضویت"
                                            ID="btnCancelMembership" UseSubmitBehavior="False" EnableViewState="False" EnableTheming="False"
                                            AutoPostBack="false" OnClick="btnCancelMembership_Click">
	...
	if (grid.GetFocusedRowIndex()&lt;0)
 {
   ...
   alert(&quot;ردیفی انتخاب نشده است&quot;);
                                    ...
                                    <td>
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="درخواست فعالسازی عضویت"
                                            ID="btnactivateMembership" UseSubmitBehavior="False" EnableViewState="False" EnableTheming="False"
                                            AutoPostBack="false" OnClick="btnactivateMembership_Click">
                                            <ClientSideEvents Click="function(s, e) {
	if (grid.GetFocusedRowIndex()&lt;0)
 {
   e.processOnServer=false;
   alert(&quot;ردیفی انتخاب نشده است&quot;);
                                            ...
                                            <Image Url="~/Images/icons/ActivateMembership.png">
                                            </Image>
                                        </TSPControls:CustomAspxButton>
                                    </td>
    ...
    e.processOnServer=true;
            ...
            <TSPControls:CustomAspxDevGridView ID="GridViewMember" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="MrsName" Width="200px"
                        Caption="وضعیت عضویت">
                        <CellStyle Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                        ...
                        <div align="center">
                            <TSPControls:CustomAspxDevGridView ID="CustomAspxDevGridViewRequest" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <dxwgv:GridViewDataTextColumn Caption="نوع درخواست" FieldName="RequestType" VisibleIndex="1">
                                    </dxwgv:GridViewDataTextColumn>
                        ...
                        <table dir="rtl">
                            <tbody>
                                <tr>
                                    <td>
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="درخواست قطع عضویت"
                                            ID="btnCancelMembership2" UseSubmitBehavior="False" EnableViewState="False" EnableTheming="False"
                                            AutoPostBack="false" OnClick="btnCancelMembership_Click">
                                            <ClientSideEvents Click="function(s, e) {
	if (grid.GetFocusedRowIndex()&lt;0)
 {
   ...
   alert(&quot;ردیفی انتخاب نشده است&quot;);
                                    ...
                                    <td>
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="درخواست فعالسازی عضویت"
                                            ID="btnactivateMembership2" UseSubmitBehavior="False" EnableViewState="False" EnableTheming="False"
                                            AutoPostBack="false" OnClick="btnactivateMembership_Click">
                                            <ClientSideEvents Click="function(s, e) {
	if (grid.GetFocusedRowIndex()&lt;0)
 {
   ...
   alert(&quot;ردیفی انتخاب نشده است&quot;);
	...
	grid.PerformCallback('Print');
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceMember" runat="server" SelectMethod="spSelectMemberForDebtor"
            ...
            <asp:ObjectDataSource ID="OdbRequest" runat="server" SelectMethod="SelectMemberRequestForCancelMembership"
                TypeName="TSP.DataManager.MemberManager">
                <SelectParameters>
