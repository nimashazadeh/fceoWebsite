<%@ Page Title="ثبت قطع عضویت" Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true" CodeFile="CancelMembershipInsert.aspx.cs" Inherits="Employee_MembersRegister_CancelMembershipInsert" %>
                ...
                <PanelCollection>
                    <dx:PanelContent>
                        <table width="100%" cellpadding="5">
                            ...
                            <tr>
                                <td align="right" valign="top" width="15%">
                                    <dxe:ASPxLabel runat="server" Text="میزان بدهی" ID="ASPxLabel5">
                                    </dxe:ASPxLabel>
                                </td>
                                <td align="right" valign="top" width="35%">
                                  <dxe:ASPxLabel runat="server" ID="txtDebt" ClientInstanceName="txtDebt"></dxe:ASPxLabel>
                                </td>
                            </tr>
                        </table>
                    </dx:PanelContent>
