<%@ Page Title="مالی پروژه" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="ProjectAccounting.aspx.cs" Inherits="Employee_TechnicalServices_Project_ProjectAccounting" %>
                        ...
                        <table style="border-collapse: collapse; background-color: transparent" dir="rtl"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="right" valign="top">
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="فیش نظارت فاقد ناظر"
                                            ID="btnNewObs" UseSubmitBehavior="False" EnableViewState="False" EnableTheming="False"
                                            OnClick="btnNewObs_Click">
                                            <HoverStyle BackColor="#FFE0C0">
                                                <border borderwidth="1px" borderstyle="Outset" bordercolor="Gray"></border>
                                            </HoverStyle>
                                            <Image Url="~/Images/icons/NewObsFish.png">
                                            </Image>
                                        </TSPControls:CustomAspxButton>
                                    </td>
                                    <td align="right" valign="top">
  ...
  grid.PerformCallback('PrintFish'); 
	...
	popupChoosePlanType.Show(); 
                                    ...
                                    <td>
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="چاپ نامه شهرداری - تایید ناظر"
                                            ID="btnObsPermit" AutoPostBack="False" UseSubmitBehavior="False" EnableViewState="False"
                                            EnableTheming="False">
                                            <ClientSideEvents Click="function(s, e) {		
	grid.PerformCallback('ObsPermitPrint');  
}"></ClientSideEvents>
                                            <HoverStyle BackColor="#FFE0C0">
                                                <border borderwidth="1px" borderstyle="Outset" bordercolor="Gray"></border>
                                            </HoverStyle>
                                    ...
                                    <td>
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="چاپ نامه شهرداری - تایید ناظر(همراه با تعهد)"
                                            ID="btnObsPermitWithText" AutoPostBack="False" UseSubmitBehavior="False" EnableViewState="False"
                                            EnableTheming="False">
                                            <ClientSideEvents Click="function(s, e) {		
	grid.PerformCallback('ObsPermitPrint2');  
}"></ClientSideEvents>
                                            <HoverStyle BackColor="#FFE0C0">
                                                <border borderwidth="1px" borderstyle="Outset" bordercolor="Gray"></border>
                                            </HoverStyle>
	...
	ShowWf();
            ...
            <TSPControls:CustomASPxRoundPanel ID="RoundPanelMain" ClientInstanceName="RoundPanelMain"
                ...
                <PanelCollection>
                    <dx:PanelContent>
                        <TSPControls:CustomAspxDevGridView ClientInstanceName="grid" Width="100%" ID="GridViewProjectAccounting"
                            runat="server" DataSourceID="ObjectDataSourceTsAcc"
                            AutoGenerateColumns="False" KeyFieldName="AccountingId" OnCustomCallback="GridViewProjectAccounting_CustomCallback">
                        ...
                        <table style="border-collapse: collapse; background-color: transparent" dir="rtl"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="right" valign="top">
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="فیش نظارت فاقد ناظر"
                                            ID="btnNewObs2" UseSubmitBehavior="False" EnableViewState="False" EnableTheming="False"
                                            OnClick="btnNewObs_Click">
                                            <HoverStyle BackColor="#FFE0C0">
                                                <border borderwidth="1px" borderstyle="Outset" bordercolor="Gray"></border>
                                            </HoverStyle>
                                                                     ...
                                                                     if (grid.GetFocusedRowIndex()&lt;0)
 {
  ...
  grid.PerformCallback('PrintFish'); 
	...
	popupChoosePlanType.Show(); 
                                    ...
                                    <td>
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="چاپ نامه شهرداری - تایید ناظر"
                                            ID="btnObsPermit2" AutoPostBack="False" UseSubmitBehavior="False" EnableViewState="False"
                                            EnableTheming="False">
                                            <ClientSideEvents Click="function(s, e) {		
	grid.PerformCallback('ObsPermitPrint');  
}"></ClientSideEvents>
                                    ...
                                    <td>
                                        <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="چاپ نامه شهرداری - تایید ناظر(همراه با تعهد)"
                                            ID="btnObsPermitWithText2" AutoPostBack="False" UseSubmitBehavior="False" EnableViewState="False"
                                            EnableTheming="False">
                                            <ClientSideEvents Click="function(s, e) {		
	grid.PerformCallback('ObsPermitPrint2');  
}"></ClientSideEvents>
