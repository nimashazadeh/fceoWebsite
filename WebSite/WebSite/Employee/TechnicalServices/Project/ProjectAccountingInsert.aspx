<%@ Page Title="مشخصات مالی پروژه" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="ProjectAccountingInsert.aspx.cs" Inherits="Employee_TechnicalServices_Project_ProjectAccountingInsert" %>
                            ...
                            <PanelCollection>
                                <dx:PanelContent>
                                    <table width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td valign="top" align="center">
                                                                ...
                                                                <dxe:ASPxLabel runat="server" ID="lblPrice" ClientInstanceName="lblPrice" ForeColor="Blue">
                                                                </dxe:ASPxLabel>
                                                            </td>
                                                        </tr>
                                        ...
                                        <tr>
                                            <td align="right" valign="top">
                                                <dxe:ASPxLabel runat="server" Text="ناظرین" ID="lblOserver" ClientVisible="false">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td align="right" valign="top" colspan="3">
                                                <TSPControls:CustomASPXDropDownEdit RightToLeft="True" ID="cmbObserver" runat="server"
                                                    Width="100%" ClientInstanceName="cmbObserver"
                                                    ClientVisible="false">
                                                    <DropDownWindowTemplate>
                                                        <TSPControls:CustomASPxListBox RightToLeft="True" ID="ListBoxGroupObserver" ClientInstanceName="ListBoxGroupObserver" runat="server" Width="100%"
                                                            SelectionMode="CheckColumn" TextField="NameAndWage" ValueField="ProjectObserversId"
                                                            DataSourceID="ObjdObserver">
                                                            <ClientSideEvents SelectedIndexChanged="function(s,e){                                               
                                                             OnListBoxSelectionChanged(s,cmbObserver,0,'',e);                                                            
                                                            CallbackPanelMain.PerformCallback('AccTypeChange');                                                             
                                                              }" />
                                                        </TSPControls:CustomASPxListBox>
                                                    </DropDownWindowTemplate>
                                                </TSPControls:CustomASPXDropDownEdit>
                                                <asp:ObjectDataSource ID="ObjdObserver" runat="server" SelectMethod="FindByProjectIdAndRequestId"
                                        ...
                                        <tr>
                                            <td align="right" valign="top" width="15%">
                                                <dxe:ASPxLabel runat="server" Text="نوع نقشه" ID="lblPlanType" ClientVisible="false">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td align="right" valign="top" width="35%">
                                                <TSPControls:CustomAspxComboBox runat="server" Width="100%"
                                                    ...
                                                    ValueField="PlansTypeId" ClientVisible="false" AutoPostBack="true" OnSelectedIndexChanged="cmbPlanType_SelectedIndexChanged">
                                            ...
                                            <td align="right" valign="top" width="15%">
                                                <dxe:ASPxLabel runat="server" Text="نام طراح" ID="lblDesigner" ClientVisible="false">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td align="right" valign="top" width="35%">
                                                <TSPControls:CustomAspxComboBox runat="server" Width="100%"
                                                    ...
                                                    ValueField="DesignerPlansId" ClientVisible="false" AutoPostBack="true" OnSelectedIndexChanged="cmbDesigner_SelectedIndexChanged">
                                        ...
                                        <tr>
                                            <td align="right" valign="top">
                                                <dxe:ASPxLabel runat="server" Text="متراژ دستمزد" ID="lblWage" ClientVisible="false">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td align="right" valign="top">
                                            ...
                                            <td align="right" valign="top">
                                                <dxe:ASPxLabel runat="server" Text="تعرفه" ID="lblPriceArchive" ClientVisible="false">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td align="right" valign="top">
