...
public partial class Employee_TechnicalServices_Project_JobHistoryShow : System.Web.UI.Page
{
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        string GrdFlt = Request.QueryString["GrdFlt"].ToString();
        string SrchFlt = Request.QueryString["SrchFlt"].ToString();
        Response.Redirect("JobHistory.aspx?ProjectId=" + HDProjectId.Value
