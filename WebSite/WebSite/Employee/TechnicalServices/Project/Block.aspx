<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true"
    CodeFile="Block.aspx.cs" Inherits="Employee_TechnicalServices_Project_Block"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	if (GridViewBlock.GetFocusedRowIndex()&lt;0)
 	{
            ...
            <table align="center" width="100%">
                <tr>
                    <td width="100%" align="center">
                        <asp:Label ID="lblWarning" Font-Bold="true" ForeColor="DarkRed" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                     <td width="100%" align="center">
                                <asp:Label visible="false" id="liCountIngrediant" Font-Bold="true" ForeColor="DarkRed" Text="به دلیل ثبت عوامل پروژه در این درخواست قادر به ویرایش بلوک های پروژه نیستید" runat="server"></asp:Label>
                    </td>
                </tr>
            </table>
            <br />
            <TSPControls:CustomAspxDevGridView ID="GridViewBlock" runat="server" DataSourceID="ObjectDataSourceBlock"
                Width="100%"
                AutoGenerateColumns="False" ClientInstanceName="GridViewBlock" KeyFieldName="BlockId"
                OnHtmlRowPrepared="GridViewBlock_HtmlRowPrepared">
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="Foundation" Caption="زیربنا"
                        Name="Foundation">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="StageNum" Caption="تعداد طبقات"
                        Name="StageNum" Width="150px">
                        <CellStyle Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="StructureSystem" Caption="سیستم سازه ای"
                        Name="StructureSystem" Width="150px">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="StructureSkeletonTitle" Caption="اسکلت ساختمان"
                        Name="StructureSkeleton" Width="150px">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn VisibleIndex="4" FieldName="RoofType" Caption="نوع سقف"
                        Name="RoofType" Width="150px">
                    </dxwgv:GridViewDataTextColumn>
                    <%--<dxwgv:GridViewDataTextColumn VisibleIndex="5" FieldName="WallLength" Caption="طول دیوار"
                            Name="WallLength">
                        </dxwgv:GridViewDataTextColumn>--%>
	...
	ShowWf();
            ...
            <uc1:WFUserControl ID="WFUserControl" runat="server" GridName="GridViewBlock" SessionName="SendBackDataTable_EmpPrjBlock"
    ...
    <asp:HiddenField ID="PgMode" runat="server" Visible="False" />
       <dxhf:ASPxHiddenField ID="HiddenFieldPage" ClientInstanceName="HiddenFieldPage"
                runat="server"></dxhf:ASPxHiddenField>
</asp:Content>
