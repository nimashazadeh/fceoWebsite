...
public partial class Employee_TechnicalServices_Capacity_CapacityReleaseInsert : System.Web.UI.Page
{
    #region Properties
    ...
    protected void txtProjectCode_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ClearForm();
                txtProjectCode.Text = _ProjectId.ToString();
    ...
    private void FillForm()
    {
        ...
        try
        {
            ...
            txtProjectCode.Text = CapacityReleaseManager[0]["ProjectId"].ToString();

            ObjectDataSourceObserver.SelectParameters["ProjectId"].DefaultValue = txtProjectCode.Text;
    ...
    private bool FillprojectInfo()
    {
        ...
        {
            if (Utility.GetCurrentAgentCode() != Utility.GetCurrentUser_AgentId() && Convert.ToInt32(dtRequestIdLastVersion.Rows[0]["AgentId"]) != Utility.GetCurrentUser_AgentId())
            {
                return false;
            }
    ...
    bool CheckEditConditions(int CapRId, int MeId)
    {
