<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true" CodeFile="CapacityRelease.aspx.cs" Inherits="Employee_TechnicalServices_Capacity_CapacityRelease" %>
   		...
   		alert(&quot;ردیفی انتخاب نشده است&quot;);
                            ...
                            <td>
                                <TSPControls:CustomAspxButton IsMenuButton="true" runat="server" Text=" " ToolTip="انتخاب ستون ها"
                                    ...
                                    <ClientSideEvents Click="function(s, e) {
	if(!GridViewCapacityRelease.IsCustomizationWindowVisible())
		GridViewCapacityRelease.ShowCustomizationWindow();
	else
		GridViewCapacityRelease.HideCustomizationWindow();
}" />
 ...
 if (ASPxClientEdit.ValidateGroup('SearchValid')){
    ...
    <TSPControls:CustomAspxDevGridView Width="100%" ID="GridViewCapacityRelease" runat="server"
        ...
        <Columns>
            ...
            <%--       <dxwgv:GridViewDataTextColumn Caption="نوع عضویت" FieldName="MeTypeName" VisibleIndex="0">
                        <CellStyle Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>--%>
            ...
            <dxwgv:GridViewDataTextColumn Caption="زیربنای پروژه" FieldName="ProjectFoundation" VisibleIndex="0">
                <CellStyle Wrap="False">
                </CellStyle>
            </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewDataTextColumn Caption="تاریخ ثیت پروژه" FieldName="ProjectDate" VisibleIndex="0">
                <CellStyle Wrap="False">
                </CellStyle>
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="شهر محل پروژه" FieldName="CitName" VisibleIndex="0">
                <CellStyle Wrap="False">
                </CellStyle>
            </dxwgv:GridViewDataTextColumn>
    ...
    <dxwgv:ASPxGridViewExporter ID="GridViewExporter" runat="server" GridViewID="GridViewCapacityRelease"
...
{	
    ...
    <uc1:WFUserControl ID="WFUserControl" runat="server" GridName="GridViewCapacityRelease"
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceCapacityRelease" runat="server" TypeName="TSP.DataManager.TechnicalServices.CapacityReleaseManager"
        SelectMethod="SelectCapacityReleaseForEmpManagementPage" OldValuesParameterFormatString="original_{0}">
        <SelectParameters>
            <asp:Parameter DefaultValue="-1" Name="AgentId" Type="Int32" />
