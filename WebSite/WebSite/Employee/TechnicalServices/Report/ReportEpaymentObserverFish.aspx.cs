...
public partial class Employee_TechnicalServices_Report_ReportEpaymentObserverFish : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            TSP.DataManager.Permission perPrintHistory = TSP.DataManager.TechnicalServices.AccountingManager.GetUserPermissionForTSEpaymentObserver(Utility.GetCurrentUser_UserId(), (TSP.DataManager.UserType)Utility.GetCurrentUser_LoginType());
    ...
    private void Search()
    {
        try
        {
            ...
            ObjectReportEpaymentDesignerFish.SelectParameters["ProjectIngridientTypeId"].DefaultValue = ((int)TSP.DataManager.TSProjectIngridientType.Observer).ToString();
            ObjectReportEpaymentDesignerFish.SelectParameters["AccTypeList"].DefaultValue = ((int)TSP.DataManager.TSAccountingAccType.ObserversFiche).ToString() + ","
