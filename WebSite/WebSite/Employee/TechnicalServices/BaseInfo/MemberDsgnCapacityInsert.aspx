<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true"
    CodeFile="MemberDsgnCapacityInsert.aspx.cs" Inherits="Employee_TechnicalServices_BaseInfo_MemberDsgnCapacityInsert"
    Title="ظرفیت اشتغال طراحی/نظارت شخص حقیقی" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <table dir="rtl" width="100%">
                                <tbody>
                                    <tr>
                                        ...
                                        <td valign="top" align="right">
                                            <asp:Label ID="Label31" runat="server" Text="حداکثر تعداد کار"></asp:Label>
                                        </td>
                                        <td valign="top" align="right">
                                            <TSPControls:CustomTextBox runat="server" ID="ASPxTextBoxMaxJobCount" >
                                    ...
                                    <tr>
                                        <td valign="top" align="right">
                                            <asp:Label ID="Label1" runat="server" Text="حداکثر ظرفیت اشتغال طراحی"></asp:Label>
                                        </td>
                                        <td valign="top" align="right">
                                        ...
                                        <td valign="top" align="right">&nbsp;<asp:Label runat="server" Text="ضریب تبدیل طراحی به نظارت" ID="Label29"></asp:Label>
                                        </td>
                                        <td valign="top" align="right">
                                            <TSPControls:CustomTextBox runat="server" ID="ASPxTextBoxObservationPercent"
                                                >
                                                <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom">
                                                    <ErrorImage Height="14px" Url="~/App_Themes/Glass/Editors/edtError.png">
                                                    </ErrorImage>
                                                    ...
                                                    <RegularExpression ErrorText="لطفا عدد تا 3 رقم اعشار وارد کنید." ValidationExpression="\d.\d{1,4}" />
                                                </ValidationSettings>
                                            </TSPControls:CustomTextBox>
                                        </td>
                                    </tr>
    ...
    <asp:HiddenField ID="PkMCId" runat="server" Visible="False" />
