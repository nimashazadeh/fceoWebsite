<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true"
    CodeFile="EngOffDsgnCapacity.aspx.cs" Inherits="Employee_TechnicalServices_BaseInfo_EngOffDsgnCapacity"
    Title="مدیریت ظرفیت اشتغال طراحی/نظارت دفاتر طراحی " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	mygrid.PerformCallback('Print');
                    ...
                    <TSPControls:CustomAspxMenuHorizontal ID="MenuDsgn" runat="server"   OnItemClick="MenuDsgn_ItemClick"
                       >
                        <Items>
                            ...
                            <dxm:MenuItem Name="EngOff" Text="دفاتر طراحی" Selected="True">
                            </dxm:MenuItem>
                ...
                <TSPControls:CustomAspxDevGridView ID="CustomAspxDevGridView1" runat="server" DataSourceID="ObjectDataSourceDocOffIncreaseJobCapacity"
                    ...
                    RightToLeft="True" OnCustomCallback="CustomAspxDevGridView1_CustomCallback" OnHtmlDataCellPrepared="CustomAspxDevGridView1_HtmlDataCellPrepared"
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="DesignIncPer" Caption="درصد افزایش دفتر مهندسی"
                            Name="DesignIncPer">
                        ...
                        <dxwgv:GridViewDataTextColumn VisibleIndex="4" FieldName="CreateDate" Caption="تاریخ تعریف"
                            Name="CreateDate" Width="90px">
                            <CellStyle CssClass="CellLeft" Wrap="false">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
