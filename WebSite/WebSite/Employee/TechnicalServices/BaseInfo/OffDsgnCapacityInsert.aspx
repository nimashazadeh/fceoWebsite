<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true"
    CodeFile="OffDsgnCapacityInsert.aspx.cs" Inherits="Employee_TechnicalServices_BaseInfo_OffDsgnCapacityInsert"
    Title="ظرفیت اشتغال طراحی/نظارت شخص حقوقی" %>
                    ...
                    <dxp:PanelContent>
                        <table dir="rtl" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <td valign="top" align="right" width="25%">
                                        <asp:Label runat="server" Text="درصد افزایش طراح حقوقی" ID="Label24"></asp:Label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td valign="top" align="right" width="25%">
                                        <pdc:PersianDateTextBox runat="server" DefaultDate="" Width="183px" Enabled="False"
