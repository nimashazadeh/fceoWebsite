...
public partial class Employee_TechnicalServices_BaseInfo_EngOffDsgnCapacityInsert : System.Web.UI.Page
{
    string PageMode;
    string InJId;
    ...
    private void InsertMemberCapacity()
    {
        ...
        RowIncreaseJobCapacity["Type"] = (int)TSP.DataManager.DocOffIncreaseJobCapacityType.EngOffice;
