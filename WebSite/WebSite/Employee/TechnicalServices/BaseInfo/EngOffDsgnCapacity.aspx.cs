...
public partial class Employee_TechnicalServices_BaseInfo_EngOffDsgnCapacity : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ObjectDataSourceDocOffIncreaseJobCapacity.SelectParameters["Type"].DefaultValue = ((int)TSP.DataManager.DocOffIncreaseJobCapacityType.EngOffice).ToString();
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        if (IsPageRefresh)
            return;
        GridViewExporter.FileName = "EngOffDsgnCapacity";
    ...
    private void NextPage(string Mode)
    {
        ...
        else
        {
            ...
            Response.Redirect("EngOffDsgnCapacityInsert.aspx?" + QS);
        }
    }
