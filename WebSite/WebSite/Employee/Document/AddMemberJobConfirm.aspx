<%@ Page Title="تاییدیه سوابق کاری" Language="C#" MasterPageFile="~/MasterPagePortals.master" AutoEventWireup="true" CodeFile="AddMemberJobConfirm.aspx.cs" Inherits="Employee_Document_AddMemberJobConfirm" %>
                            ...
                            <table width="100%">
                                     <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" valign="top" colspan="3">
                                                    <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="100%" MaxLength="150" ID="txtPosition"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" width="80%" align="right" valign="top">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="100%" MaxLength="30" ID="txtOfficeName"
                                ...
                                <tr>
                                    ...
                                    <td align="right" valign="top">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="100%" MaxLength="30" ClientVisible="false"
                                        ...
                                        <TSPControls:CustomASPxRoundPanel ID="RoundPanelconfMember1" ClientInstanceName="RoundPanelconfMember1"
                                            ...
                                            ID="lblHelpMeId"  ClientInstanceName="lblHelpMeId" Width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="30%" align="right" valign="top">
                                                                <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="100%" MaxLength="30" ID="txtMeId1"
