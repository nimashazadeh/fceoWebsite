<%@ Page Title="مدیریت شیوه اخذ پروانه" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="DocMemberFileAcceptTypes.aspx.cs" Inherits="Employee_Document_DocMemberFileAcceptTypes" %>
...
if (grid.GetFocusedRowIndex()&lt;0)
 {
  ...
  e.processOnServer= confirm('آیا مطمئن به فعال کردن این ردیف هستید؟');
            ...
            <TSPControls:CustomAspxDevGridView ID="grdTypes" runat="server" ClientInstanceName="grid"
                DataSourceID="ObjectDataSourceTypes" KeyFieldName="ActTypeId" OnRowInserting="grdTypes_RowInserting"
                OnRowUpdating="grdTypes_RowUpdating" Width="100%" RightToLeft="True"><Settings ShowHorizontalScrollBar="true" />
                <Columns>
                    <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="ActTypeName" Caption="نام"
                        Name="ResName" Width="45%">
...
if (grid.GetFocusedRowIndex()&lt;0)
 {
  ...
  e.processOnServer= confirm('آیا مطمئن به فعال کردن این ردیف هستید؟');
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceTypes" runat="server" SelectMethod="GetAllData"
        TypeName="TSP.DataManager.DocMemberFileAcceptTypeManager"></asp:ObjectDataSource>
</asp:Content>
