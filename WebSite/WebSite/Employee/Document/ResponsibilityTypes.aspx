<%@ Page Title="مدیریت صلاحیت ها" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="ResponsibilityTypes.aspx.cs" Inherits="Employee_Document_ResponsibilityTypes" %>
...
if (grid.GetFocusedRowIndex()&lt;0)
 {
  ...
  e.processOnServer= confirm('آیا مطمئن به فعال کردن این ردیف هستید؟');
            ...
            <TSPControls:CustomAspxDevGridView ID="grdTypes" runat="server" ClientInstanceName="grid"
                DataSourceID="ObjectDataSourceTypes" KeyFieldName="ResId" OnRowInserting="grdTypes_RowInserting"
                OnRowUpdating="grdTypes_RowUpdating" Width="100%" RightToLeft="True"><Settings ShowHorizontalScrollBar="true" />
                <Columns>
                    <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="ResName" Caption="نام"
                        Name="ResName" Width="90%">
