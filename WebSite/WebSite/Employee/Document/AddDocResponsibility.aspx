<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="AddDocResponsibility.aspx.cs" Inherits="Employee_Document_AddDocResponsibility"
                                ...
                                <PanelCollection>
                                    <dxp:PanelContent>
                                        <div align="center" width="100%">
                                            <asp:Label Visible="false" runat="server" ID="lblWarningInActiveMajor" Text="رشته موضوع پروانه انتخاب شده غیرفعال شده است و صلاحیت تعریف شده در گواهینامه چاپ نمی شود." ForeColor="Red"></asp:Label>
                                        </div>
                                        <table width="100%">

                                            <tbody>
                                                <tr>
                                                    <td valign="top" align="right" style="width: 15%">رشته موضوع پروانه *
                                                    </td>
                                                    ...
                                                    <td style="vertical-align: top; width: 15%" align="right">رشته و مقطع تحصیلی
                                                    </td>
                                                    <td style="vertical-align: top; width: 35%" align="right">
                                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server" ID="txtMeLicence" Width="100%"
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top" align="right">
                                                        ...
                                                        <asp:ObjectDataSource ID="ObjdsMeDocAcceptType" runat="server" UpdateMethod="Update"
                                                            TypeName="TSP.DataManager.DocMemberFileAcceptTypeManager" SelectMethod="GetData"></asp:ObjectDataSource>
                                                    </td>
                                                    <td valign="top" align="right">پایه - صلاحیت *
                                                    </td>
                                                    <td valign="top" align="right">
                                                        <TSPControls:CustomAspxComboBox RightToLeft="True" runat="server" Width="100%"
                                                        ...
                                                        <asp:ObjectDataSource ID="ObjdsAcceptGrad" runat="server" TypeName="TSP.DataManager.DocAcceptedGradeManager"
                                                            ...
                                                            <SelectParameters>
                                                                ...
                                                                <asp:Parameter Type="Int32" DefaultValue="-1" Name="GasGrdId"></asp:Parameter>
                                                            </SelectParameters>
                                                        </asp:ObjectDataSource>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" align="right">تاریخ اخذ صلاحیت *
                                                    </td>
                                                    <td valign="top" align="right">
                                                    ...
                                                    <td valign="top" align="right">حدود صلاحیت*
                                                    </td>
                                                    <td valign="top" align="right">
                                                        <TSPControls:CustomAspxComboBox RightToLeft="True" runat="server" Width="100%"
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <TSPControls:CustomAspxButton IsMenuButton="true" CausesValidation="false" runat="server" Text=" "
