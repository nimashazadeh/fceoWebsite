...
public partial class Employee_Document_EngOffice_EngOfficeJobShow : System.Web.UI.Page
{
    #region Events
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("EngOfficeJob.aspx?EOfId=" + EngFileId.Value + "&PageMode=" + PgMode.Value + "&EngOfId=" + EngOfficeId.Value + "&GrdFlt=" + Request.QueryString["GrdFlt"] + "&SrchFlt=" + Request.QueryString["SrchFlt"]);
