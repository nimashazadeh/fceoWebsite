<%@ Page Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="EngOfficeJobShow.aspx.cs" Inherits="Employee_Document_EngOffice_EngOfficeJobShow"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3" align="right" valign="top">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="282px" ID="txtjPrName"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" align="right" valign="top">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="170px" ID="txtjEmployer"
   ...
   if(CmbPrType.GetValue() == '1')
	...
	lbl3.SetVisible(false);
                                    ...
                                    <td align="right" valign="top">&nbsp;<dxe:ASPxLabel runat="server" Text="نوع سازه" ID="ASPxLabel10" ClientInstanceName="lbl3"
                                        ClientVisible="False">
                                    </dxe:ASPxLabel>
                                    </td>
                                    <td dir="ltr" align="right" valign="top">
   ...
   if(CmbPosition.GetValue()=='8' || CmbPosition.GetValue()=='9')
		...
		rdpJob.SetVisible(false);
                                    ...
                                    <td align="right" valign="top">&nbsp;<dxe:ASPxLabel runat="server" Text="نحوه مشارکت" ID="ASPxLabel24">
                                    </dxe:ASPxLabel>
                                    </td>
                                    <td dir="ltr" align="right" valign="top">
                                        <TSPControls:CustomAspxComboBox runat="server"
                                ...
                                <tr>
                                    ...
                                    <td align="right" valign="top">&nbsp;<dxe:ASPxLabel runat="server" Text="شهر" ID="ASPxLabel13">
                                    </dxe:ASPxLabel>
                                    </td>
                                    <td align="right" valign="top">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="170px" ID="txtjCity" ClientInstanceName="TextCity"
                                             ReadOnly="True">
                                            <ValidationSettings ValidateOnLeave="False" Display="Dynamic" ValidationGroup="j"
                                                ErrorTextPosition="Bottom">
                                ...
                                <tr>
                                    ...
                                    <td align="right" valign="top">&nbsp;<dxe:ASPxLabel runat="server" Text="حجم پروژه" ID="ASPxLabel21">
                                    </dxe:ASPxLabel>
                                    </td>
                                    <td align="right" valign="top">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="170px" ID="txtjPrVolume"
                                ...
                                <tr>
                                    ...
                                    <td align="right" valign="top">&nbsp;<dxe:ASPxLabel runat="server" Text="تاریخ پایان همکاری" ID="ASPxLabel19">
                                    </dxe:ASPxLabel>
                                    </td>
                                    <td align="right" valign="top">
                                        <pdc:PersianDateTextBox runat="server" DefaultDate="" Width="185px" ShowPickerOnTop="True"
                                ...
                                <tr>
                                    ...
                                    <td align="right" valign="top">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="170px" ID="txtjStartStatus"
                                            ClientInstanceName="TextSStatus" 
                                            ReadOnly="True">
                                        </TSPControls:CustomTextBox>
                                    </td>
                                    <td align="right" valign="top">&nbsp;<dxe:ASPxLabel runat="server" Text="وضعیت پروژه در زمان پایان همکاری" Width="110px"
                                        ID="ASPxLabel20">
                                    </dxe:ASPxLabel>
                                    </td>
                                    <td align="right" valign="top">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  Width="170px" ID="txtjEndStatus"
                                ...
                                <tr>
                                    ...
                                    <td align="right" valign="top">
                                        <TSPControls:CustomTextBox IsMenuButton="true" runat="server"  ClientVisible="False" Width="170px"
                                    ...
                                    <td align="right" valign="top">&nbsp;<dxe:ASPxLabel runat="server" Text="تعداد طبقات" ClientVisible="False" ID="ASPxLabel23"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" align="right" valign="top">
                                        <TSPControls:CustomASPXMemo runat="server" Height="33px"  Width="530px" ID="txtjDesc"
            ...
            <br />
            <TSPControls:CustomASPxRoundPanel ID="RoundPanelPrj" HeaderText="مشاهده" runat="server"
                Width="100%">
                <PanelCollection>
                    <dxp:PanelContent>
                                        <table>
    ...
    <asp:ObjectDataSource ID="ODBJobCountry" runat="server" DeleteMethod="Delete" InsertMethod="Insert"
        ...
        CacheDuration="3600"></asp:ObjectDataSource>
