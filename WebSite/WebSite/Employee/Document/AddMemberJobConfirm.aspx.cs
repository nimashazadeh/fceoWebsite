...
public partial class Employee_Document_AddMemberJobConfirm : System.Web.UI.Page
{
    ...
    {
        ClearForm();
        Response.Redirect("MemberConfirmJobHistory.aspx?PgMd=" + Utility.EncryptQS(PrePgMd) + "&MFId=" + Utility.EncryptQS(MFId.ToString()) + "&DocType=" + Request.QueryString["DocType"]);
    }
    ...
    private void FillForm(int JobConfId)
    {
        ...
        if (DocMemberFileJobConfirmationManager.Count == 1)
        {
            ...
            if (DocMemberFileJobConfirmationManager[0]["FromDate"] != null)
                txtDateFrom.Text = DocMemberFileJobConfirmationManager[0]["FromDate"].ToString();
            if (DocMemberFileJobConfirmationManager[0]["ToDate"] != null)
            ...
            if (Convert.ToInt32(cmbConfirmType.Value) == (int)TSP.DataManager.DocumentJobConfirmType.Office)
            {
                ...
                Session["JobGrdURL"] = ImageGrd.ImageUrl = DocMemberFileJobConfirmationManager[0]["GrdURL"].ToString();
            ...
            {
                txtMeId1.Text = DocMemberFileJobConfirmationManager[0]["MeId"].ToString();
                txtMeId1_TextChanged(this, new EventArgs());
                txtDescription.Text = DocMemberFileJobConfirmationManager[0]["Description"].ToString();
                ImageConf.ImageUrl = DocMemberFileJobConfirmationManager[0]["FileURL"].ToString();
            }
    ...
    private void Insert()
    {
        ...
        try
        {
            ...
            if (!Utility.IsDBNullOrNullValue(txtMeId1.Text))
            {
                MejobConfirmRow["MeId"] = txtMeId1.Text;
                MejobConfirmRow["Name"] = lblMeName1.Text;
            }
            ...
            if (Session["JobFileURL"] != null)
            {
                MejobConfirmRow["FileURL"] = Session["JobFileURL"].ToString();
            }
            if (Session["JobGrdURL"] != null)
            {
                MejobConfirmRow["GrdURL"] = Session["JobGrdURL"].ToString();
            }
    ...
    private void Edit(int JobConfId)
    {
        ...
        try
        {
            ...
            if (DocMemberFileJobConfirmationManager.Count == 1)
            {
                ...
                if (!Utility.IsDBNullOrNullValue(txtMeId1.Text))
                {
                    DocMemberFileJobConfirmationManager[0]["MeId"] = txtMeId1.Text;
                    DocMemberFileJobConfirmationManager[0]["Name"] = lblMeName1.Text;
                }
                if (!Utility.IsDBNullOrNullValue(ComboProvince.Text))
                {
                ...
                if (Session["JobFileURL"] != null)
                    DocMemberFileJobConfirmationManager[0]["FileURL"] = Session["JobFileURL"].ToString();
                if (Session["JobGrdURL"] != null)
                    DocMemberFileJobConfirmationManager[0]["GrdURL"] = Session["JobGrdURL"].ToString();
