...
public partial class Employee_Document_Reports_OfficePrintingHistory : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            TSP.DataManager.Permission perCardRequest = TSP.DataManager.MemberManager.GetUserPermissionForOfficeDocumentPrintReport(Utility.GetCurrentUser_UserId(),
        ...
        objdsPrintingHistory.SelectParameters["TableType"].DefaultValue = ((int)TSP.DataManager.TableType.OfficeRequest).ToString();
    ...
    {
        GridViewExporter.FileName = "OfficeDocumentReport";
        ...
        if (!string.IsNullOrEmpty(e.Parameters))
        {
            switch (e.Parameters)
            {
                case "Print":
                    ...
                    Session["Title"] = "گزارش چاپ پروانه اشتغال به کار شرکت های حقوقی";
                    break;
            }
        }
    }
