<%@ Page Title="گزارش چاپ کارت های پروانه دفاتر مهندسی" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="EngOfficePrintingHistory.aspx.cs" Inherits="Employee_Document_Reports_EngOfficePrintingHistory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <TSPControls:CustomAspxDevGridView ID="GridViewMemberRequest" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            <dxwgv:GridViewDataTextColumn Caption="کد دفتر" FieldName="Id" VisibleIndex="0">
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="نام دفتر" FieldName="Name" VisibleIndex="1"
                Width="200px">
            </dxwgv:GridViewDataTextColumn>
    ...
    <asp:ObjectDataSource ID="objdsPrintingHistory" runat="server" TypeName="TSP.DataManager.PrintingHistoryManager"
        ...
        <SelectParameters>
            <asp:Parameter DbType="Int32" DefaultValue="418" Name="TableType" />
