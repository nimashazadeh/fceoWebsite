...
public partial class Employee_Document_Reports_MemberImpDocPrintingHistory : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            TSP.DataManager.Permission per = TSP.DataManager.PrintingHistoryManager.GetUserPermissionImplementDoc(Utility.GetCurrentUser_UserId(), (TSP.DataManager.UserType)Utility.GetCurrentUser_LoginType());
        ...
        if (!string.IsNullOrEmpty(e.Parameters))
        {
            switch (e.Parameters)
            {
                case "Print":
                    ...
                    Session["Title"] = "گزارش چاپ کارت های مجوز فعالیت مجری حقیقی";
                    break;
            }
        }
    }
