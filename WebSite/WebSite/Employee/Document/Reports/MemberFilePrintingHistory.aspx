<%@ Page Title="گزارش چاپ کارت های پروانه اشتغال به  کار" Language="C#" MasterPageFile="~/MasterPagePortals.master"
    AutoEventWireup="true" CodeFile="MemberFilePrintingHistory.aspx.cs" Inherits="Employee_Document_Reports_MemberFilePrintingHistory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 if (ASPxClientEdit.ValidateGroup('SearchValid')){
    ...
    <asp:ObjectDataSource ID="objdsPrintingHistory" runat="server" TypeName="TSP.DataManager.PrintingHistoryManager"
        SelectMethod="SelectPrintHistoryForMemberFile">
        <SelectParameters>
