...
public partial class Employee_OfficeRegister_OfficeJob : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ReqManager.Count > 0)
            {
                ...
                {
                    ObjectDataSource1.SelectParameters[5].DefaultValue = "2";
            ...
            //                Session["FillOfJob"] = JobManager.FindByMeRequest(int.Parse(OfId), -1, 1, 1);
            ...
            //            Session["FillOfJob"] = JobManager.FindByMeRequest(int.Parse(OfId), int.Parse(OfReId), -1, 1);
            ...
            //this.ViewState["BtnJudgment"] = btnJudgment.Visible;
    ...
    {
        Response.Redirect("OfficeJobInsert.aspx?JhId=" + Utility.EncryptQS("") + "&aPageMode=" + Utility.EncryptQS("New") + "&OfId=" + OfficeId.Value + "&PageMode=" + PgMode.Value + "&OfReId=" + OfficeRequest.Value + "&GrdFlt=" + Request.QueryString["GrdFlt"] + "&SrchFlt=" + Request.QueryString["SrchFlt"]
                ...
                if (JobManager.Count == 1)
                {
                    ...
                    if (OfReId == CurrentOfReId)
                    {
                        ...
                        if ((Department == "Document" && CheckPermitionForEditForDoc(OfReId)) || (Department == "MemberShip" && CheckPermitionForEditForOffice(OfReId)))
                            Response.Redirect("OfficeJobInsert.aspx?JhId=" + Utility.EncryptQS(JhId.ToString()) + "&aPageMode=" + Utility.EncryptQS("Edit") + "&OfId=" + OfficeId.Value + "&PageMode=" + PgMode.Value + "&OfReId=" + OfficeRequest.Value + "&GrdFlt=" + Request.QueryString["GrdFlt"] + "&SrchFlt=" + Request.QueryString["SrchFlt"]
                                + "&Dprt=" + HiddenFieldOffice["Department"].ToString());
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("OfficeJobInsert.aspx?JhId=" + Utility.EncryptQS(JhId.ToString()) + "&aPageMode=" + Utility.EncryptQS("View") + "&OfId=" + OfficeId.Value + "&PageMode=" + PgMode.Value + "&OfReId=" + OfficeRequest.Value + "&GrdFlt=" + Request.QueryString["GrdFlt"] + "&SrchFlt=" + Request.QueryString["SrchFlt"]
                    + "&Dprt=" + HiddenFieldOffice["Department"].ToString());
            ...
            else
            {
                ...
                if (JhManager.Count == 1)
                {
                    ...
                    else
                    {
                        ...
                        //if (Convert.ToBoolean(JhManager[0]["InActive"]))
                        //{
                        //    this.DivReport.Visible = true;
                        //    this.LabelWarning.Text = "رکورد مورد نظر غیر فعال می باشد";
                        //    return;
    ...
    //{
        ...
        //        {
        //            Response.Redirect("OfficeJobInsert.aspx?JhId=" + Utility.EncryptQS(JhId.ToString()) + "&aPageMode=" + Utility.EncryptQS("Judge") + "&OfId=" + OfficeId.Value + "&PageMode=" + PgMode.Value + "&OfReId=" + OfficeRequest.Value + "&GrdFlt=" + Request.QueryString["GrdFlt"] + "&SrchFlt=" + Request.QueryString["SrchFlt"]);
