...
/// <summary>
/// Summary description for XtraReportTSOffObsTotalCapacity
/// </summary>
public class XtraReportTSOffObsTotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffObsTotalCapacity(int OfficeId)
    {
        InitializeComponent();
        //
        ...
        Cpcty.GetCapacityInformation((int)TSP.DataManager.TSProjectIngridientType.Observer, (int)TSP.DataManager.TSMemberType.Office, Convert.ToInt32(OfficeId), false);

        SetObsTexts(Cpcty.IngridientMaxJobCapacity.ToString(), Cpcty.IngridientMaxJobCount.ToString(), Cpcty.IngridientUsedCapacityValue.ToString(), Cpcty.IngridientRemainCapacity.ToString(), Cpcty.IngridientReservedCapacityValue.ToString(), Cpcty.IngridientProjectNum.ToString(), Cpcty.IngridientConditionalCapacityObserve.ToString());
        XtraReportTSOffObsMembers ReMembers = new XtraReportTSOffObsMembers(OfficeId);
    ...
    {
        string resourceFileName = "XtraReportTSOffObsTotalCapacity.resx";
        ...
        // 
        // XtraReportTSOffObsTotalCapacity
        // 
