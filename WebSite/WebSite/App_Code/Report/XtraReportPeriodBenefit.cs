...
/// <summary>
/// Summary description for XtraReportPeriodBenefit
/// </summary>
public class XtraReportPeriodBenefit : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private XRTableCell xrTBed;
    private XRTableCell xrTBes;
    ...
    public XtraReportPeriodBenefit(int PId, string DocDateFrom, string DocDateTo, int AgentId, int DocNumberFrom, int DocNumberTo, string FilterExp, int DocStatusId, int AccTypeId)
    {
        InitializeComponent();
        //
        ...
        System.Data.DataTable dt = DocBalanceDetailManager.PeriodBenefitSelect(PId, DocDateFrom, DocDateTo, AgentId, DocNumberFrom, DocNumberTo, DocStatusId,AccTypeId);
        ...
        xrTBes.DataBindings.Add("Text", this.DataSource, "Bes");
        xrTBed.DataBindings.Add("Text", this.DataSource, "Bed");
        ...
        xrLBedSum.DataBindings.Add("Text", this.DataSource, "Bed");
        xrLBesSum.DataBindings.Add("Text", this.DataSource, "Bes");
        xrLBalanceSum.DataBindings.Add("Text", this.DataSource, "Balance");
        xrTBalance.DataBindings[0].FormatString = "{0:#,#}";
        xrTBed.DataBindings[0].FormatString = "{0:#,#}";
        xrTBes.DataBindings[0].FormatString = "{0:#,#}";
    ...
    {
        string resourceFileName = "XtraReportPeriodBenefit.resx";
        ...
        this.xrTBed = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrTBes = new DevExpress.XtraReports.UI.XRTableCell();
        ...
        this.xrTBalance.Weight = 0.30365420436092383;
        // 
        // xrTBed
        // 
        this.xrTBed.Name = "xrTBed";
        this.xrTBed.StylePriority.UseTextAlignment = false;
        this.xrTBed.Text = "xrTBed";
        this.xrTBed.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.xrTBed.Weight = 0.34521457977981873;
        // 
        // xrTBes
        // 
        this.xrTBes.Name = "xrTBes";
        this.xrTBes.StylePriority.UseTextAlignment = false;
        this.xrTBes.Text = "xrTBes";
        this.xrTBes.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.xrTBes.Weight = 0.3523013798857797;
        // 
        // xrTaccName
        // 
        this.xrTaccName.Name = "xrTaccName";
        this.xrTaccName.Text = "xrTaccName";
        this.xrTaccName.Weight = 0.8781664008555381;
        // 
        // xrTAccCode
        // 
        this.xrTAccCode.Name = "xrTAccCode";
        this.xrTAccCode.Text = "xrTAccCode";
        this.xrTAccCode.Weight = 0.73504249475220107;
        // 
        // xrTGroupName
        // 
        this.xrTGroupName.Name = "xrTGroupName";
        this.xrTGroupName.Text = "xrTGroupName";
        this.xrTGroupName.Weight = 0.60436349469069772;
        // 
        // xrTTitle
        // 
        ...
        this.xrTTitle.Weight = 0.41779029482834751;
        // 
        // PageHeader
        // 
        ...
        this.xrTable2.Location = new System.Drawing.Point(0, 242);
        ...
        this.xrTableCell13.Text = "مبلغ";
        this.xrTableCell13.Weight = 0.36873232320800342;
        // 
        // xrTableCell11
        // 
        this.xrTableCell11.Name = "xrTableCell11";
        this.xrTableCell11.Text = "زیان";
        this.xrTableCell11.Weight = 0.36931763683627861;
        // 
        // xrTableCell4
        // 
        this.xrTableCell4.Name = "xrTableCell4";
        this.xrTableCell4.Text = "سود";
        this.xrTableCell4.Weight = 0.36455965756365583;
        // 
        // xrTableCell12
        // 
        this.xrTableCell12.Name = "xrTableCell12";
        this.xrTableCell12.Text = "نام حساب";
        this.xrTableCell12.Weight = 0.96001056095452841;
        // 
        // xrTableCell8
        // 
        ...
        this.xrTableCell6.Weight = 0.64794654460289469;
        // 
        // xrTableCell9
        // 
        this.xrTableCell9.Name = "xrTableCell9";
        this.xrTableCell9.Weight = 0.55468659684880628;
        // 
        // xrTable8
        // 
        ...
        this.xrLabel37.Text = "سود و زیان";
        ...
        this.xrLBedSum.Location = new System.Drawing.Point(67, 8);
        ...
        this.xrLBedSum.Summary = xrSummary2;
        ...
        this.xrLBesSum.Location = new System.Drawing.Point(133, 8);
        ...
        this.xrLBesSum.Summary = xrSummary3;
