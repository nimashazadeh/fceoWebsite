...
/// <summary>
/// Summary description for XtraReportTSREngOffDsgnTotalCapacity
/// </summary>
public class XtraReportTSREngOffDsgnTotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSREngOffDsgnTotalCapacity(int EngOfId, string Year)
    {
        InitializeComponent();
        //
        ...
        //if (EngOfId > 0 && Year != "")
        //    CapacityInfoDT = Cpcty.GetYearInformation((int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.TSMemberType.EngOffice, EngOfId, Year);
    ...
    {     //************************************************************
        ...
        //MemberDt = Cpcty.GetOfficeMembersDsgObsCapacityInYear(EOfId, (int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.DocOffIncreaseJobCapacityType.EngOffice, FId, Yr);
        ...
        //xrTMemTotalCapacity.DataBindings.Add("Text", MemberDt, "TotalCapacity");
    ...
    {
        string resourceFileName = "XtraReportTSREngOffDsgnTotalCapacity.resx";
        ...
        this.xrLabel12.Text = "اعضای دفتر";
        ...
        // 
        // XtraReportTSREngOffDsgnTotalCapacity
        // 
