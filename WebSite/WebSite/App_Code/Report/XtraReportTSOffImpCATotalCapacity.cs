...
/// <summary>
/// Summary description for XtraReportTSOffImpCATotalCapacity
/// </summary>
public class XtraReportTSOffImpCATotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffImpCATotalCapacity(int OfficeId)
    {
        InitializeComponent();
        //
        ...
        Cpcty.GetCapacityInformation((int)TSP.DataManager.TSProjectIngridientType.Implementer, (int)TSP.DataManager.TSMemberType.Office, Convert.ToInt32(OfficeId), true);        
        SetCapacityAssignmentImpTexts(Cpcty.IngridientMaxJobCapacity.ToString(), Cpcty.IngridientMaxJobCount.ToString(), Cpcty.IngridientUsedCapacityValue.ToString(), Cpcty.IngridientRemainCapacity.ToString(),Cpcty.IngridientProjectNum.ToString(), Cpcty.IngridientConditionalCapacityImplement.ToString(),Cpcty.IngridientMaxFloor.ToString());
        SetCurrentStage();
    ...
    private void SetCapacityAssignmentImpTexts(string TotalCapacity, string MaxJobCount, string TotalUsed, string RemainCapacity, string ProjectCount, string ConditionalCapacity, string MaxFloor)
    {
        ...
        xrTProjectCount.Text = RemainCapacity;
        xrTMaxFloor.Text = ProjectCount;
    ...
    {
        string resourceFileName = "XtraReportTSOffImpCATotalCapacity.resx";
        ...
        this.xrTable1.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow1});
        this.xrTable1.Size = new System.Drawing.Size(1849, 400);
        // 
        // xrTableRow1
        // 
        ...
        this.xrTable4.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            ...
            this.xrTableRow4,
            this.xrTableRow5});
        this.xrTable4.Size = new System.Drawing.Size(1829, 384);
        ...
        this.xrLabel3.Location = new System.Drawing.Point(127, 8);
        this.xrLabel3.Name = "xrLabel3";
        this.xrLabel3.Padding = new DevExpress.XtraPrinting.PaddingInfo(5, 5, 0, 0, 254F);
        this.xrLabel3.Size = new System.Drawing.Size(254, 50);
        this.xrLabel3.StylePriority.UseBorders = false;
        this.xrLabel3.StylePriority.UseFont = false;
        this.xrLabel3.StylePriority.UseTextAlignment = false;
        this.xrLabel3.Text = "حداکثر تعداد طبقات";
        ...
        // 
        this.xrTConditionalCapacity.Borders = DevExpress.XtraPrinting.BorderSide.Left;
        ...
        this.xrLabel12.Location = new System.Drawing.Point(21, 8);
        ...
        this.xrLabel2.Location = new System.Drawing.Point(169, 8);
        ...
        // 
        // XtraReportTSOffImpCATotalCapacity
        // 
