...
/// <summary>
/// Summary description for XtraReportTSEngOffDsgnCapacity
/// </summary>
public class XtraReportTSEngOffDsgnCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSEngOffDsgnCapacity(int EngOfId, string Year)
    {
        InitializeComponent();
        //
        ...
        XtraReportTSEngOffReport ReOffInfo = new XtraReportTSEngOffReport(EngOfId, Year);
        xrSubOffInfo.ReportSource = ReOffInfo;

        XtraReportTSREngOffDsgnTotalCapacity ReTotalCapacity = new XtraReportTSREngOffDsgnTotalCapacity(EngOfId, Year);
        xrSubTotalCapacity.ReportSource = ReTotalCapacity;

        XtraReportTSREngOffDsgnCATotalCapacity ReCATotalCapacity = new XtraReportTSREngOffDsgnCATotalCapacity(EngOfId, Year);
    ...
    {
        string resourceFileName = "XtraReportTSEngOffDsgnCapacity.resx";
        ...
        this.xrSubOffInfo.Location = new System.Drawing.Point(0, 85);
        ...
        this.xrLabel37.Text = "گزارش ظرفیت طراحی دفاتر";
        ...
        // 
        // XtraReportTSEngOffDsgnCapacity
        // 
