...
/// </summary>
public class DocBalanceReport : DevExpress.XtraReports.UI.XtraReport
{
    private DevExpress.XtraReports.UI.DetailBand Detail;
    private DevExpress.XtraReports.UI.PageFooterBand PageFooter;
    TSP.DataManager.AccountingDocBalanceDetailManager docBalanceDetailManager;
    TSP.DataManager.AccountingDocBalanceManager docBalanceManager;
    TSP.DataManager.AccountingDocOperationManager docOperationManager;
    DataTable dt;
    ...
    public DocBalanceReport(int DocBalanceId)
    {

        docBalanceDetailManager = new TSP.DataManager.AccountingDocBalanceDetailManager();
        docBalanceManager = new TSP.DataManager.AccountingDocBalanceManager();
        docOperationManager = new TSP.DataManager.AccountingDocOperationManager();
        InitializeComponent();
        //
        ...
        {
            docOperationManager.FindById(Convert.ToInt32(docBalanceManager[0]["DocOperationId"]));
            if (docOperationManager.Count > 0)
            {
                dt = docBalanceDetailManager.FindByParentIdForReport(DocBalanceId);
    ...
    public DocBalanceReport(TSP.DataManager.AccountingDocBalanceDetailManager manager)
    {
        docBalanceDetailManager = manager;
        docBalanceManager = new TSP.DataManager.AccountingDocBalanceManager();
        docOperationManager = new TSP.DataManager.AccountingDocOperationManager();
        dt = manager.DataTable;
        InitializeComponent();
        //
        // TODO: Add constructor logic here
        //
        
        docBalanceManager.FindById(Convert.ToInt32(docBalanceDetailManager[0]["DocBalanceId"]));
        docOperationManager.FindById(Convert.ToInt32(docBalanceManager[0]["DocOperationId"]));        
    ...
    {
        string resourceFileName = "DocBalanceReport.resx";
        ...
        // 
        // 
        this.formattingRule1.Formatting.BackColor = System.Drawing.Color.Empty;
        ...
        this.xrLblCurDate.Location = new System.Drawing.Point(8, 15);
        ...
        this.xrLabel15.Location = new System.Drawing.Point(83, 15);
