...
/// <summary>
/// Summary description for XtraReportTSMemObsCapacityInfo
/// </summary>
public class XtraReportTSMemObsCapacityInfo : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSMemObsCapacityInfo(int MeId)
    {
        InitializeComponent();
        //
        ...
        //************************************************************
        //************************************************************
        //XtraReportTSMembersInfo ReOffInfo = new XtraReportTSMembersInfo(MeId,(int)TSP.DataManager.TSProjectIngridientType.Observer);
        //xrSubOffInfo.ReportSource = ReOffInfo;

        //SetObservationCapacity(MeId);
        //SetCapacityAssignmentObservationCapacity(MeId);
        //SetCurrentStage();        
        
    }

    private void SetObservationCapacity(int MeId)
    {
        ...
        //{
        //    SetObsTexts(CapacityInfoArr[0].ToString(), CapacityInfoArr[5].ToString(), CapacityInfoArr[1].ToString(), CapacityInfoArr[2].ToString(), CapacityInfoArr[3].ToString(), CapacityInfoArr[4].ToString(), CapacityInfoArr[7].ToString(), MemberArr[2].ToString());
        //}
    }
    

    //private void SetObsTexts(string TotalCapacity, string MaxJobCount, string TotalUsed, string RemainCapacity, string Reserve, string ProjectCount, string ConditionalCapacity, string ObservationPercent)
    //{
    ...
    //    xrTObservationPercent.Text = ObservationPercent;      

    //}

    //private void SetCapacityAssignmentObservationCapacity(int MeId)
    //{
    ...
    //    CapacityInfoArr = Cpcty.GetCapacityInformationPerStage((int)TSP.DataManager.TSProjectIngridientType.Observer, (int)TSP.DataManager.TSMemberType.Member, MeId);
    ...
    {
        string resourceFileName = "XtraReportTSMemObsCapacityInfo.resx";
        ...
        // xrTRemainCapacity
        // 
        this.xrTRemainCapacity.Borders = DevExpress.XtraPrinting.BorderSide.None;
        ...
        this.xrTRemainCapacity.Weight = 0.76479499319591571;
        // 
        // xrTableCell13
        // 
        ...
        this.xrLabel2.Location = new System.Drawing.Point(169, 10);
        ...
        // 
        this.xrTObservationPercent.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.xrTObservationPercent.Dpi = 254F;
        this.xrTObservationPercent.Name = "xrTObservationPercent";
        this.xrTObservationPercent.StylePriority.UseBorders = false;
        this.xrTObservationPercent.Text = "xrTObservationPercent";
        this.xrTObservationPercent.Weight = 1;
        // 
        // xrTableCell5
        // 
        ...
        this.xrTable7.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow6});
        this.xrTable7.Size = new System.Drawing.Size(1849, 415);
        // 
        // xrTableRow6
        // 
        ...
        this.xrTable8.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            ...
            this.xrTableRow10,
            this.xrTableRow11});
        this.xrTable8.Size = new System.Drawing.Size(1829, 320);
        ...
        // xrTCATotalUsed
        // 
        this.xrTCATotalUsed.Borders = DevExpress.XtraPrinting.BorderSide.Left;
        this.xrTCATotalUsed.Dpi = 254F;
        this.xrTCATotalUsed.Name = "xrTCATotalUsed";
        this.xrTCATotalUsed.StylePriority.UseBorders = false;
        this.xrTCATotalUsed.StylePriority.UseTextAlignment = false;
        this.xrTCATotalUsed.Text = "xrTCATotalUsed";
        this.xrTCATotalUsed.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
        ...
        this.xrTableCell20.Text = "کل کارکرد";
        ...
        // 
        this.xrTCAConditionalCapacity.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
        ...
        this.xrTableCell24.Text = "کاهش/افزایش ظرفیت";
        ...
        this.xrLabel37.Location = new System.Drawing.Point(267, 159);
        ...
        this.xrLabel37.Text = "ظرفیت نظارت عضو حقیقی";
        ...
        // 
        // XtraReportTSMemObsCapacityInfo
        // 
