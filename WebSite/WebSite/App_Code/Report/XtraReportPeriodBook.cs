...
/// <summary>
/// Summary description for XtraReportPeriodBook
/// </summary>
public class XtraReportPeriodBook : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportPeriodBook(int PId, int AccId, string DocDateFrom, string DocDateTo, int AgentId, string FilterExp, int DocStatusId, string K, string M, int DocNumberFrom, int DocNumberTo)
    {
        InitializeComponent();
        //
        ...
        System.Data.DataTable dt = DocBalanceDetailManager.PeriodBookSelect(PId,AccId, DocDateFrom, DocDateTo, AgentId, DocStatusId,K,M,DocNumberFrom,DocNumberTo);
    ...
    {
        string resourceFileName = "XtraReportPeriodBook.resx";
