...
/// <summary>
/// Summary description for XtraReportTSOffDsgnCapacityInfo
/// </summary>
public class XtraReportTSOffDsgnCapacityInfo : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffDsgnCapacityInfo(int OfficeId)
    {
        InitializeComponent();
        //
        ...
        XtraReportTSOffInfo ReOffInfo = new XtraReportTSOffInfo(OfficeId);
        xrSubOffInfo.ReportSource = ReOffInfo;

        XtraReportTSOffDsgnTotalCapacity ReTotalCapacity = new XtraReportTSOffDsgnTotalCapacity(OfficeId);
        xrSubTotalCapacity.ReportSource = ReTotalCapacity;

        XtraReportTSOffDsgnCATotalCapacity ReCATotalCapacity = new XtraReportTSOffDsgnCATotalCapacity(OfficeId);
    ...
    {
        string resourceFileName = "XtraReportTSOffDsgnCapacityInfo.resx";
        ...
        this.xrLabel37.Text = "ظرفیت طراحی عضو حقوقی";
        ...
        // 
        // XtraReportTSOffDsgnCapacityInfo
        // 
