...
/// <summary>
/// Summary description for XtraReportTSREngOffDsgnCATotalCapacity
/// </summary>
public class XtraReportTSREngOffDsgnCATotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSREngOffDsgnCATotalCapacity(int EngOfId, string Year)
    {
        InitializeComponent();
        //
    ...
    //    StageInfoDT = Cpcty.GetStageInformation((int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.TSMemberType.EngOffice, EOfId, Yr, Stage);
    ...
    //    MemberDt = Cpcty.GetOfficeMembersDsgObsCapacityInYearPerStage(EOfId, (int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.DocOffIncreaseJobCapacityType.EngOffice, FId, Yr, Stage);
    ...
    {
        string resourceFileName = "XtraReportTSREngOffDsgnCATotalCapacity.resx";
        ...
        // 
        // XtraReportTSREngOffDsgnCATotalCapacity
        // 
