...
/// <summary>
/// Summary description for XtraReportTSEngOffDsgnCATotalCapacity
/// </summary>
public class XtraReportTSEngOffDsgnCATotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSEngOffDsgnCATotalCapacity(int EngOfId)
    {
        InitializeComponent();
        //
        ...
        Cpcty.GetCapacityInformation((int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.TSMemberType.EngOffice, Convert.ToInt32(EngOfId), true);        
        ...
        XtraReportTSEngOffDsgnCAMembers ReMembers = new XtraReportTSEngOffDsgnCAMembers(EngOfId);
    ...
    {
        string resourceFileName = "XtraReportTSEngOffDsgnCATotalCapacity.resx";
        ...
        // 
        // XtraReportTSEngOffDsgnCATotalCapacity
        // 
