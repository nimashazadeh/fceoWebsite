...
/// <summary>
/// Summary description for XtraReportTSOffObsCATotalCapacity
/// </summary>
public class XtraReportTSOffObsCATotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffObsCATotalCapacity(int OfficeId)
    {
        InitializeComponent();
        //
        ...
        Cpcty.GetCapacityInformation((int)TSP.DataManager.TSProjectIngridientType.Observer, (int)TSP.DataManager.TSMemberType.Office, Convert.ToInt32(OfficeId), true);        
        SetCapacityAssignmentObsTexts(Cpcty.IngridientMaxJobCapacity.ToString(), Cpcty.IngridientMaxJobCount.ToString(), Cpcty.IngridientUsedCapacityValue.ToString(), Cpcty.IngridientRemainCapacity.ToString(),Cpcty.IngridientProjectNum.ToString(), Cpcty.IngridientConditionalCapacityObserve.ToString());
        SetCurrentStage();

        XtraReportTSOffObsCAMembers ReMembers = new XtraReportTSOffObsCAMembers(OfficeId);
    ...
    {
        string resourceFileName = "XtraReportTSOffObsCATotalCapacity.resx";
        ...
        // 
        // XtraReportTSOffObsCATotalCapacity
        // 
