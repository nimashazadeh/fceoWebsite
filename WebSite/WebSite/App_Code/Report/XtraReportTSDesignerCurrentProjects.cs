...
/// <summary>
/// Summary description for XtraReportTSDesignerCurrentProjects
/// </summary>
public class XtraReportTSDesignerCurrentProjects : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSDesignerCurrentProjects(int OfficeEngOId, int MemberTypeId, string FilterExp)
    {
        InitializeComponent();
        //
        ...
        labelMeOfficeId.Text = OfficeEngOId.ToString();
        System.Data.DataTable dt = ProjectManager.SelectDesignerCurrentProjects(OfficeEngOId, MemberTypeId);
    ...
    {
        string resourceFileName = "XtraReportTSDesignerCurrentProjects.resx";
        ...
        this.xrLabel37.Text = "پروژه های در دست اجرا طراح";
        ...
        this.xrTableCell34.Text = "نام طراح";
        ...
        // 
        // XtraReportTSDesignerCurrentProjects
        // 
