...
/// <summary>
/// Summary description for XtraReportPeriodFishReport
/// </summary>
public class XtraReportPeriodFishReport : DevExpress.XtraReports.UI.XtraReport
{
    private DevExpress.XtraReports.UI.DetailBand Detail;
    private DevExpress.XtraReports.UI.PageHeaderBand PageHeader;
    private DevExpress.XtraReports.UI.PageFooterBand PageFooter;    

    private TSP.DataManager.AccountingPrintedBankFishManager PrintedBankFishManager = new TSP.DataManager.AccountingPrintedBankFishManager();
    ...
    private XRTableCell xrTAccNameTo;
    private XRTableCell xrTAccNameFrom;
    private XRTableCell xrTPayDate;
    private XRTableCell xrTPrice;
    private XRTableCell xrTDocNumber;
    private XRTableCell xrTPrnBnkFishCode;
    ...
    public XtraReportPeriodFishReport(int PId,int AgentId, string FilterExp)
    {
        InitializeComponent();
        //
        // TODO: Add constructor logic here
        //
        System.Data.DataTable dt = PrintedBankFishManager.SelectPeriodPrintedBankFishManager(PId, AgentId);
        dt.DefaultView.RowFilter = FilterExp;
        this.DataSource = dt;

        xrTPrnBnkFishCode.DataBindings.Add("Text", this.DataSource, "PrnBnkFishCode");
        xrTDocNumber.DataBindings.Add("Text", this.DataSource, "DocNumber");
        xrTPrice.DataBindings.Add("Text", this.DataSource, "Price");
        xrTPayDate.DataBindings.Add("Text", this.DataSource, "PayDate");
        xrTAccNameFrom.DataBindings.Add("Text", this.DataSource, "AccNameFrom");
        xrTAccNameTo.DataBindings.Add("Text", this.DataSource, "AccNameTo");

        xrTAgent.Text = GetAgentName(AgentId);
        xrTPrice.DataBindings[0].FormatString = "{0:#,#}";
    }
    ...
    {
        string resourceFileName = "XtraReportPeriodFishReport.resx";
        this.Detail = new DevExpress.XtraReports.UI.DetailBand();
        this.xrTable1 = new DevExpress.XtraReports.UI.XRTable();
        this.xrTableRow1 = new DevExpress.XtraReports.UI.XRTableRow();
        this.xrTAccNameTo = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrTAccNameFrom = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrTPayDate = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrTPrice = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrTDocNumber = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrTPrnBnkFishCode = new DevExpress.XtraReports.UI.XRTableCell();
        ...
        this.xrTableRow1.Cells.AddRange(new DevExpress.XtraReports.UI.XRTableCell[] {
            ...
            this.xrTPrice,
            this.xrTDocNumber,
            this.xrTPrnBnkFishCode});
        this.xrTableRow1.Name = "xrTableRow1";
        this.xrTableRow1.Weight = 1;
        // 
        // xrTAccNameTo
        // 
        this.xrTAccNameTo.Name = "xrTAccNameTo";
        this.xrTAccNameTo.StylePriority.UseTextAlignment = false;
        this.xrTAccNameTo.Text = "xrTAccNameTo";
        this.xrTAccNameTo.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.xrTAccNameTo.Weight = 0.77261069287383655;
        // 
        // xrTAccNameFrom
        // 
        this.xrTAccNameFrom.Name = "xrTAccNameFrom";
        this.xrTAccNameFrom.StylePriority.UseTextAlignment = false;
        this.xrTAccNameFrom.Text = "xrTAccNameFrom";
        this.xrTAccNameFrom.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.xrTAccNameFrom.Weight = 0.80926005566033843;
        // 
        // xrTPayDate
        // 
        this.xrTPayDate.Name = "xrTPayDate";
        this.xrTPayDate.Text = "xrTPayDate";
        this.xrTPayDate.Weight = 0.47257118340235371;
        // 
        // xrTPrice
        // 
        this.xrTPrice.Name = "xrTPrice";
        this.xrTPrice.Text = "xrTPrice";
        this.xrTPrice.Weight = 0.51412092287506672;
        // 
        // xrTDocNumber
        // 
        this.xrTDocNumber.Name = "xrTDocNumber";
        this.xrTDocNumber.Text = "xrTDocNumber";
        this.xrTDocNumber.Weight = 0.552941335274099;
        // 
        // xrTPrnBnkFishCode
        // 
        this.xrTPrnBnkFishCode.Name = "xrTPrnBnkFishCode";
        this.xrTPrnBnkFishCode.Text = "xrTPrnBnkFishCode";
        this.xrTPrnBnkFishCode.Weight = 0.60234653821394879;
        // 
        // xrLabel8
        // 
        ...
        this.xrTableCell13.Text = "نام دریافت کننده";
        this.xrTableCell13.Weight = 0.92498133650416159;
        // 
        // xrTableCell11
        // 
        this.xrTableCell11.Name = "xrTableCell11";
        this.xrTableCell11.Text = "نام پرداخت کننده";
        this.xrTableCell11.Weight = 0.97544131272294854;
        // 
        // xrTableCell4
        // 
        this.xrTableCell4.Name = "xrTableCell4";
        this.xrTableCell4.Text = "تاریخ پرداخت";
        this.xrTableCell4.Weight = 0.56678926040428068;
        // 
        // xrTableCell7
        // 
        this.xrTableCell7.Name = "xrTableCell7";
        this.xrTableCell7.Text = "مبلغ";
        this.xrTableCell7.Weight = 0.61639114387633787;
        // 
        // xrTableCell12
        // 
        this.xrTableCell12.Name = "xrTableCell12";
        this.xrTableCell12.Text = "شماره سند";
        this.xrTableCell12.Weight = 0.6662026254458977;
        // 
        // xrTableCell9
        // 
        this.xrTableCell9.Name = "xrTableCell9";
        this.xrTableCell9.Text = "شماره فیش";
        this.xrTableCell9.Weight = 0.71304259690844241;
        // 
        // xrTable8
        // 
