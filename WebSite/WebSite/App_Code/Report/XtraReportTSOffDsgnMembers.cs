...
/// <summary>
/// Summary description for XtraReportTSOffDsgnMembers
/// </summary>
public class XtraReportTSOffDsgnMembers : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffDsgnMembers(int OfficeId)
    {
        InitializeComponent();
        //
    ...
    {
        string resourceFileName = "XtraReportTSOffDsgnMembers.resx";
