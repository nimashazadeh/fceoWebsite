...
/// <summary>
/// Summary description for XtraReportBalance8Columns
/// </summary>
public class XtraReportBalance8Columns : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportBalance8Columns(string DocDateFrom, string DocDateTo, int AgentId,int AccTypeId, string FilterExp)
    {
        InitializeComponent();
        //
        ...
        System.Data.DataTable dt = DocBalanceDetailManager.Balance8Columns(DocDateFrom, DocDateTo, AgentId,AccTypeId);
    ...
    {
        string resourceFileName = "XtraReportBalance8Columns.resx";
        ...
        this.xrLabel33.Location = new System.Drawing.Point(69, 0);
        ...
        this.xrLabel34.Location = new System.Drawing.Point(58, 0);
