...
/// <summary>
/// Summary description for XtraReportTSOffImpCapacityInfo
/// </summary>
public class XtraReportTSOffImpCapacityInfo : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffImpCapacityInfo(int OfficeId)
    {
        InitializeComponent();
        //
        ...
        XtraReportTSOffImpTotalCapacity ReTotalCapacity = new XtraReportTSOffImpTotalCapacity(OfficeId);
        xrSubTotalCapacity.ReportSource = ReTotalCapacity;

        XtraReportTSOffImpCATotalCapacity ReCATotalCapacity = new XtraReportTSOffImpCATotalCapacity(OfficeId);
    ...
    {
        string resourceFileName = "XtraReportTSOffImpCapacityInfo.resx";
        ...
        this.xrLabel37.Text = "ظرفیت اجرا عضو حقوقی";
        ...
        this.xrPageBreak1.Location = new System.Drawing.Point(0, 381);
        this.xrPageBreak1.Name = "xrPageBreak1";
        // 
        // XtraReportTSOffImpCapacityInfo
        // 
