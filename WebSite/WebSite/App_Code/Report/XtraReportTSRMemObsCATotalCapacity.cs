...
/// <summary>
/// Summary description for XtraReportTSRMemObsCATotalCapacity
/// </summary>
public class XtraReportTSRMemObsCATotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSRMemObsCATotalCapacity(int MeId, string Year)
    {
        InitializeComponent();
        //
    ...
    {     //************************************************************
        ...
        //StageInfoDT = Cpcty.GetStageInformation((int)TSP.DataManager.TSProjectIngridientType.Observer, (int)TSP.DataManager.TSMemberType.Member, MId, Yr, Stage);
        ...
        //xrTObservationPercent.DataBindings.Add("Text", StageInfoDT, "ObservationPercent");
    ...
    {
        string resourceFileName = "XtraReportTSRMemObsCATotalCapacity.resx";
        ...
        this.xrTableCell4.Text = "ضریب تبدیل طراحی به نظارت";
        ...
        this.xrTObservationPercent.Weight = 0.21788534205620896;
        // 
        // xrTMaxJobCount
        // 
        ...
        // 
        // XtraReportTSRMemObsCATotalCapacity
        // 
