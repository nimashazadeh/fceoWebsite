...
/// <summary>
/// Summary description for XtraReportTSOffDsgnTotalCapacity
/// </summary>
public class XtraReportTSOffDsgnTotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffDsgnTotalCapacity(int OfficeId)
    {
        InitializeComponent();
        //
        ...
        //CapacityInfoArr = Cpcty.GetCapacityInformation((int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.TSMemberType.Office, OfficeId);
        Cpcty.GetCapacityInformation((int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.TSMemberType.Office, OfficeId, false);
        ...
        XtraReportTSOffDsgnMembers ReMembers = new XtraReportTSOffDsgnMembers(OfficeId);
    ...
    {
        string resourceFileName = "XtraReportTSOffDsgnTotalCapacity.resx";
        ...
        // 
        // XtraReportTSOffDsgnTotalCapacity
        // 
