...
/// <summary>
/// Summary description for XtraReportBenefit
/// </summary>
public class XtraReportBenefit : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportBenefit(string DocDateFrom, string DocDateTo, int AgentId, int DocNumberFrom, int DocNumberTo, string FilterExp, int DocStatusId, int AccTypeId)
    { 
        InitializeComponent();
        //
        ...
        System.Data.DataTable dt = DocBalanceDetailManager.BenefitSelect(DocDateFrom, DocDateTo, AgentId, DocNumberFrom, DocNumberTo,DocStatusId,AccTypeId);
    ...
    {
        string resourceFileName = "XtraReportBenefit.resx";
