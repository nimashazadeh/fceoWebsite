...
/// <summary>
/// Summary description for XtraReportServices
/// </summary>
public class XtraReportServices : DevExpress.XtraReports.UI.XtraReport
{
    private DevExpress.XtraReports.UI.DetailBand Detail;

    private TSP.DataManager.AccountingServiceManager ServiceManager = new TSP.DataManager.AccountingServiceManager();
    ...
    private XRTableCell xrTServiceName;
    ...
    public XtraReportServices(string FilterExp)
    {
        InitializeComponent();
        //
        ...
        ServiceManager.FindByAgent(Utility.GetCurrentUser_AgentId());
        System.Data.DataTable dt = ServiceManager.DataTable;
        dt.DefaultView.RowFilter = FilterExp;
        this.DataSource = dt;

        xrTServiceName.DataBindings.Add("Text", this.DataSource, "ServiceName");
    ...
    {
        string resourceFileName = "XtraReportServices.resx";
        ...
        this.xrTServiceName = new DevExpress.XtraReports.UI.XRTableCell();
        ...
        this.xrTPrice.Weight = 0.67802501668785131;
        // 
        // xrTAccCode
        // 
        this.xrTAccCode.Name = "xrTAccCode";
        this.xrTAccCode.Text = "xrTAccCode";
        this.xrTAccCode.Weight = 0.47303015621796723;
        // 
        // xrTAccName
        // 
        this.xrTAccName.Name = "xrTAccName";
        this.xrTAccName.Text = "xrTAccName";
        this.xrTAccName.Weight = 0.51185056861699962;
        // 
        // xrTServiceName
        // 
        this.xrTServiceName.Name = "xrTServiceName";
        this.xrTServiceName.Text = "xrTServiceName";
        this.xrTServiceName.Weight = 0.73075518401738471;
        // 
        // xrLabel8
        // 
