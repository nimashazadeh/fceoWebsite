...
/// <summary>
/// Summary description for XtraReportTSOffObsCapacityInfo
/// </summary>
public class XtraReportTSOffObsCapacityInfo : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffObsCapacityInfo(int OfficeId)
    {
        InitializeComponent();
        //
        ...
        XtraReportTSOffObsTotalCapacity ReTotalCapacity = new XtraReportTSOffObsTotalCapacity(OfficeId);
        xrSubTotalCapacity.ReportSource = ReTotalCapacity;

        XtraReportTSOffObsCATotalCapacity ReCATotalCapacity = new XtraReportTSOffObsCATotalCapacity(OfficeId);
    ...
    {
        string resourceFileName = "XtraReportTSOffObsCapacityInfo.resx";
        ...
        this.xrLabel37.Text = "ظرفیت نظارت عضو حقوقی";
        ...
        // 
        // XtraReportTSOffObsCapacityInfo
        // 
