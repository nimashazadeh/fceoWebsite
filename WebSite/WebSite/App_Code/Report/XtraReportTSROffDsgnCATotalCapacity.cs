...
/// <summary>
/// Summary description for XtraReportTSROffDsgnCATotalCapacity
/// </summary>
public class XtraReportTSROffDsgnCATotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSROffDsgnCATotalCapacity(int OfficeId, string Year)
    {
        InitializeComponent();
        //
    ...
    {     //************************************************************
        ...
        //StageInfoDT = Cpcty.GetStageInformation((int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.TSMemberType.Office, OffId, Yr, Stage);
    ...
    {     //************************************************************
        ...
        //MemberDt = Cpcty.GetOfficeMembersDsgObsCapacityInYearPerStage(OffId, (int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.DocOffIncreaseJobCapacityType.Office, FId, Yr, Stage);
    ...
    {
        string resourceFileName = "XtraReportTSROffDsgnCATotalCapacity.resx";
        ...
        // 
        // XtraReportTSROffDsgnCATotalCapacity
        // 
