...
/// <summary>
/// Summary description for XtraReportTSOffDsgnCapacity
/// </summary>
public class XtraReportTSOffDsgnCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffDsgnCapacity(int OfficeId, string Year)
    {
        InitializeComponent();
        //
        ...
        XtraReportTSOffReport ReOffInfo = new XtraReportTSOffReport(OfficeId, Year);
        xrSubOffInfo.ReportSource = ReOffInfo;

        XtraReportTSROffDsgnTotalCapacity ReTotalCapacity = new XtraReportTSROffDsgnTotalCapacity(OfficeId, Year);
        xrSubTotalCapacity.ReportSource = ReTotalCapacity;

        XtraReportTSROffDsgnCATotalCapacity ReCATotalCapacity = new XtraReportTSROffDsgnCATotalCapacity(OfficeId, Year);
    ...
    {
        string resourceFileName = "XtraReportTSOffDsgnCapacity.resx";
        ...
        this.xrLabel37.Text = "گزارش ظرفیت طراحی عضو حقوقی";
