...
/// <summary>
/// Summary description for XtraReportTSROffDsgnTotalCapacity
/// </summary>
public class XtraReportTSROffDsgnTotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSROffDsgnTotalCapacity(int OfficeId, string Year)
    {
        InitializeComponent();
        //
        ...
        //if (OfficeId > 0 && Year != "")
        //    CapacityInfoDT = Cpcty.GetYearInformation((int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.TSMemberType.Office, OfficeId, Year);
    ...
    private void XtraReportTSROffDsgnTotalCapacity_DataSourceRowChanged(object sender, DataSourceRowEventArgs e)
    {
        ...
        //MemberDt = Cpcty.GetOfficeMembersDsgObsCapacityInYear(OffId, (int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.DocOffIncreaseJobCapacityType.Office, FId, Yr);
    ...
    {
        string resourceFileName = "XtraReportTSROffDsgnTotalCapacity.resx";
        ...
        // 
        // XtraReportTSROffDsgnTotalCapacity
        // 
