...
/// <summary>
/// Summary description for XtraReportBalance
/// </summary>
public class XtraReportBalance : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportBalance(int AccTypeId, string DocDateFrom, string DocDateTo, int AgentId, int DocNumberFrom, int DocNumberTo, string FilterExp, int DocStatusId)
    {
        InitializeComponent();
        //
        ...
        System.Data.DataTable dt = DocBalanceDetailManager.BalanceSelect(AccTypeId, DocDateFrom, DocDateTo, AgentId, DocNumberFrom, DocNumberTo,DocStatusId);
    ...
    {
        string resourceFileName = "XtraReportBalance.resx";
