...
/// <summary>
/// Summary description for XtraReportJornal
/// </summary>
public class XtraReportJornal : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportJornal(int AccTypeId, string DocDateFrom, string DocDateTo, int AgentId, string FilterExp, int DocStatusId)
    {
        InitializeComponent();
        //
        // TODO: Add constructor logic here
        //
        System.Data.DataTable dt= DocBalanceDetailManager.JornalSelect(AccTypeId, "%", DocDateFrom, DocDateTo, "%", -1, AgentId,DocStatusId);
    ...
    {
        string resourceFileName = "XtraReportJornal.resx";
