...
/// <summary>
/// Summary description for XtraReportBalance3
/// </summary>
public class XtraReportBalance3 : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportBalance3(string DocDateFrom, string DocDateTo, int AgentId,  string FilterExp, int DocStatusId,int Level)
    {
        InitializeComponent();
        //
    ...
    {
        string resourceFileName = "XtraReportBalance3.resx";
