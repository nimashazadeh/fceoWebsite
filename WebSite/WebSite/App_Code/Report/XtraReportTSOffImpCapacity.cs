...
/// <summary>
/// Summary description for XtraReportTSOffImpCapacity
/// </summary>
public class XtraReportTSOffImpCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffImpCapacity(int OfficeId, string Year)
    {
        InitializeComponent();
        //
        ...
        XtraReportTSROffImpTotalCapacity ReTotalCapacity = new XtraReportTSROffImpTotalCapacity(OfficeId, Year);
        xrSubTotalCapacity.ReportSource = ReTotalCapacity;

        XtraReportTSROffImpCATotalCapacity ReCATotalCapacity = new XtraReportTSROffImpCATotalCapacity(OfficeId, Year);
    ...
    {
        string resourceFileName = "XtraReportTSOffImpCapacity.resx";
        ...
        this.xrLabel37.Text = "گزارش ظرفیت اجرای عضو حقوقی";
