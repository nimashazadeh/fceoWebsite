...
/// <summary>
/// Summary description for XtraReportTSOffObsCapacity
/// </summary>
public class XtraReportTSOffObsCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffObsCapacity(int OfficeId, string Year)
    {
        InitializeComponent();
        //
        ...
        XtraReportTSROffObsTotalCapacity ReTotalCapacity = new XtraReportTSROffObsTotalCapacity(OfficeId, Year);
        xrSubTotalCapacity.ReportSource = ReTotalCapacity;

        XtraReportTSROffObsCATotalCapacity ReCATotalCapacity = new XtraReportTSROffObsCATotalCapacity(OfficeId, Year);
    ...
    {
        string resourceFileName = "XtraReportTSOffObsCapacity.resx";
        ...
        this.xrLabel37.Text = "گزارش ظرفیت نظارت عضو حقوقی";
