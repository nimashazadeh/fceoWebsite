...
/// <summary>
/// Summary description for XtraReportTSOffObsCAMembers
/// </summary>
public class XtraReportTSOffObsCAMembers : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffObsCAMembers(int OfficeId)
    {
        InitializeComponent();
        //
    ...
    {
        string resourceFileName = "XtraReportTSOffObsCAMembers.resx";
