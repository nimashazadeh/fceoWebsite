...
/// <summary>
/// Summary description for XtraReportTSEngOffDsgnTotalCapacity
/// </summary>
public class XtraReportTSEngOffDsgnTotalCapacity : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private XRSubreport xrSubEngOfficeMembers;
    /// <summary>
    /// Required designer variable.
    /// </summary>
    private System.ComponentModel.IContainer components = null;

    public XtraReportTSEngOffDsgnTotalCapacity(int EngOfId)
    {
        InitializeComponent();
        //
        ...
        Cpcty.GetCapacityInformation((int)TSP.DataManager.TSProjectIngridientType.Designer, (int)TSP.DataManager.TSMemberType.EngOffice, Convert.ToInt32(EngOfId), false);
        
        SetDsgTexts(Cpcty.IngridientMaxJobCapacity.ToString(), Cpcty.IngridientMaxJobCount.ToString(), Cpcty.IngridientUsedCapacityValue.ToString(), Cpcty.IngridientRemainCapacity.ToString(), Cpcty.IngridientReservedCapacityValue.ToString(), Cpcty.IngridientProjectNum.ToString(), Cpcty.IngridientConditionalCapacityDesign.ToString());


        XtraReportTSEngOffDsgnMembers ReMembers = new XtraReportTSEngOffDsgnMembers(EngOfId);
        xrSubEngOfficeMembers.ReportSource = ReMembers;
    }
    ...
    {
        string resourceFileName = "XtraReportTSEngOffDsgnTotalCapacity.resx";
        ...
        this.xrSubEngOfficeMembers = new DevExpress.XtraReports.UI.XRSubreport();
        ...
        // 
        // xrSubEngOfficeMembers
        // 
        this.xrSubEngOfficeMembers.Dpi = 254F;
        this.xrSubEngOfficeMembers.Location = new System.Drawing.Point(0, 275);
        this.xrSubEngOfficeMembers.Name = "xrSubEngOfficeMembers";
        this.xrSubEngOfficeMembers.Size = new System.Drawing.Size(1799, 64);
        // 
        // PageHeader
        // 
        ...
        // 
        // XtraReportTSEngOffDsgnTotalCapacity
        // 
