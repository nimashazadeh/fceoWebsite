...
/// <summary>
/// Summary description for XtraReportTSOffDsgnCAMembers
/// </summary>
public class XtraReportTSOffDsgnCAMembers : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReportTSOffDsgnCAMembers(int OfficeId)
    {
        InitializeComponent();
        //
        ...
        //************************************************************
        //************************************************************
        //DataTable MemberDt = FillMemberStepsGrid(OfficeId);
    ...
    //private DataTable FillMemberStepsGrid(int OfficeId)
    //{
    ...
    {
        string resourceFileName = "XtraReportTSOffDsgnCAMembers.resx";
