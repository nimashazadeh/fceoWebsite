...
/// <summary>
/// Summary description for XtraReportAccGroup
/// </summary>
public class XtraReportAccGroup : DevExpress.XtraReports.UI.XtraReport
{
    private DevExpress.XtraReports.UI.DetailBand Detail;

    private TSP.DataManager.AccountingAccGroupManager AccGroupManager = new TSP.DataManager.AccountingAccGroupManager();
    ...
    private XRTableCell xrTGroupStatusName;
    private XRTableCell xrTGroupTypeName;
    ...
    public XtraReportAccGroup(string FilterExp)
    {
        InitializeComponent();
        //
        ...
        AccGroupManager.Fill();
        System.Data.DataTable dt = AccGroupManager.DataTable;
        dt.DefaultView.RowFilter = FilterExp;
        this.DataSource = dt;

        xrTGroupName.DataBindings.Add("Text", this.DataSource, "GroupName");
        xrTGroupTypeName.DataBindings.Add("Text", this.DataSource, "GroupTypeName");
        xrTGroupStatusName.DataBindings.Add("Text", this.DataSource, "GroupStatusName");
    ...
    {
        string resourceFileName = "XtraReportAccGroup.resx";
        ...
        this.xrTGroupStatusName = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrTGroupTypeName = new DevExpress.XtraReports.UI.XRTableCell();
        ...
        this.xrTableRow1.Cells.AddRange(new DevExpress.XtraReports.UI.XRTableCell[] {
            this.xrTDescription,
            this.xrTTitle,
            this.xrTGroupStatusName,
            this.xrTGroupTypeName,
            this.xrTGroupName});
        ...
        this.xrTDescription.StylePriority.UseTextAlignment = false;
        this.xrTDescription.Text = "xrTDescription";
        this.xrTDescription.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.xrTDescription.Weight = 1.3301898027594405;
        // 
        // xrTTitle
        // 
        this.xrTTitle.Name = "xrTTitle";
        this.xrTTitle.Text = "xrTTitle";
        this.xrTTitle.Weight = 0.67802501668785131;
        // 
        // xrTGroupStatusName
        // 
        this.xrTGroupStatusName.Name = "xrTGroupStatusName";
        this.xrTGroupStatusName.Text = "xrTGroupStatusName";
        this.xrTGroupStatusName.Weight = 0.47303015621796723;
        // 
        // xrTGroupTypeName
        // 
        this.xrTGroupTypeName.Name = "xrTGroupTypeName";
        this.xrTGroupTypeName.Text = "xrTGroupTypeName";
        this.xrTGroupTypeName.Weight = 0.51185056861699962;
        // 
        // xrTGroupName
        // 
